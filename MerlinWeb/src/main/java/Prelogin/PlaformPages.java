	...
	public void beforeTest() 
	  {
		...
		spark = new ExtentSparkReporter("TestReports\\PreLoginTest\\PlatformPage\\plaformPagesReport.html");
	...
	public void a1_iPhonePage() throws InterruptedException
	  {
		...
		boolean a=true;
		try {webDriver.findElement(By.xpath("//*[text()='iPhone']")).click();}
	...
	public void a2_section1() throws InterruptedException
	  {
		...
		boolean a=true;
		try {webDriver.findElement(By.xpath("//*[text()='Parental Control App for iPhone']"));}
		catch(NoSuchElementException e){a=false;
		test1.fail("Section title is not correct");}
		if(a==true){test1.pass("Section title is correct");}   	
		
		a=true;
		try {webDriver.findElement(By.xpath("//*[text()='Comprehensive iPhone parental controls for busy, tech-savvy parents of young children']"));}
		catch(NoSuchElementException e){a=false;
		test1.fail("Section sub title is not correct");}
		if(a==true){test1.pass("Section sub title is correct");} 
		
		a=true;
		try {webDriver.findElement(By.xpath("//div[@class='email_btn_container']/child::a[text()='Start Free Trial']")).click();}
		catch(NoSuchElementException e){a=false;
		...
		a=true;
		try {webDriver.findElement(By.xpath("//div[@class='download_image']/child::a/picture/img"));}
		catch(NoSuchElementException e){a=false;
		test1.fail("Download icon not present");}
		if(a==true){test1.pass("Download icon present");} 		
		
		a=true;
		try {webDriver.findElement(By.xpath("//div[@class='platform_banner_image']/child::picture/img"));}
		catch(NoSuchElementException e){a=false;
	...
	public void a3_section2() throws InterruptedException
	  {
		...
		boolean a=true;
		try {webDriver.findElement(By.xpath("//*[text()='Features of our iPhone Parental Control App']"));}
		catch(NoSuchElementException e){a=false;
		test2.fail("Section title is not correct");}
		if(a==true){test2.pass("Section title is correct");}		
		
		a=true;
		try {webDriver.findElement(By.xpath("//*[text()='Track Location']"));}
		catch(NoSuchElementException e){a=false;
		test2.fail("Feature - Track Location text not correct");}
		if(a==true){test2.pass("1 - Track Location text correct");}
		
		a=true;
		try {webDriver.findElement(By.xpath("//ul[@class='sub_features_ul']/li[1]/div[1]"));}
		catch(NoSuchElementException e){a=false;
		...
		a=true;
		try {webDriver.findElement(By.xpath("//*[@id=\'sub_feature\']"));}
		catch(NoSuchElementException e){a=false;
		...
		a=true;
		try {webDriver.findElement(By.xpath("//ul[@class='sub_features_ul']/li[2]/div[1]"));}
		catch(NoSuchElementException e){a=false;
		test2.fail("sub text not present");}
		if(a==true){test2.pass("sub text present");}
		...
		a=true;
		try {webDriver.findElement(By.xpath("//*[text()='Filter Web Content']"));}
		catch(NoSuchElementException e){a=false;
		...
		a=true;
		try {webDriver.findElement(By.xpath("//ul[@class='sub_features_ul']/li[3]/div[1]"));}
		catch(NoSuchElementException e){a=false;
		test2.fail("sub text not present");}
		if(a==true){test2.pass("sub text present");}
		...
		a=true;
		try {webDriver.findElement(By.xpath("//*[text()='Block Apps']"));}
		catch(NoSuchElementException e){a=false;
		...
		a=true;
		try {webDriver.findElement(By.xpath("//ul[@class='sub_features_ul']/li[4]/div[1]"));}
		catch(NoSuchElementException e){a=false;
		test2.fail("sub text not present");}
		if(a==true){test2.pass("sub text present");}
		...
		a=true;
		try {webDriver.findElement(By.xpath("//*[text()='Set App Limits']"));}
		catch(NoSuchElementException e){a=false;
		...
		a=true;
		try {webDriver.findElement(By.xpath("//ul[@class='sub_features_ul']/li[5]/div[1]"));}
		catch(NoSuchElementException e){a=false;
		test2.fail("sub text not present");}
		if(a==true){test2.pass("sub text present");}
		...
		a=true;
		try {webDriver.findElement(By.xpath("//ul[@class='sub_features_ul']/li[6]/div[1]"));}
		catch(NoSuchElementException e){a=false;
		test2.fail("sub text not present");}
		if(a==true){test2.pass("sub text present");}
		...
		a=true;
		try {webDriver.findElement(By.xpath("//*[text()='Teach Self-Regulation']"));}
		catch(NoSuchElementException e){a=false;
		test2.fail("Feature - Teach Self-Regulation text not correct");}
		if(a==true){test2.pass("7 - Teach Self-Regulation text correct");}
		
		a=true;
		try {webDriver.findElement(By.xpath("//ul[@class='sub_features_ul']/li[7]/div[1]"));}
		catch(NoSuchElementException e){a=false;
		test2.fail("sub text not present");}
		if(a==true){test2.pass("sub text present");}
	...
	public void a4_section3() throws InterruptedException
	  {
		...
		boolean a=true;
		try {webDriver.findElement(By.xpath("//*[text()='How to Set Up Mobicip’s iPhone Parental Control']"));}
		catch(NoSuchElementException e){a=false;
		...
		a=true;
		try {webDriver.findElement(By.xpath("//p[@class='get_started_label']/a")).click();}
		catch(NoSuchElementException e){a=false;
		...
		a=true;
		try {webDriver.findElement(By.xpath("//ul[@class='get_started_ul']/li[1]"));}
		catch(NoSuchElementException e){a=false;
		...
		a=true;
		try {webDriver.findElement(By.xpath("//ul[@class='get_started_ul']/li[1]/div/a/picture/img"));}
		catch(NoSuchElementException e){a=false;
		test3.fail("Download icon not present");}
		if(a==true){test3.pass("Download icon present");}
		
		a=true;
		try {webDriver.findElement(By.xpath("//ul[@class='get_started_ul']/li[2]"));}
		catch(NoSuchElementException e){a=false;
		...
		a=true;
		try {webDriver.findElement(By.xpath("//p[text()='Create username & 'and text()=' password']"));}
		catch(NoSuchElementException e){a=false;
		test3.fail("Create username & password text not present");}
		if(a==true){test3.pass("Create username & password text present");}
		
		a=true;
		try {webDriver.findElement(By.xpath("//ul[@class='get_started_ul']/li[3]"));}
		catch(NoSuchElementException e){a=false;
		...
		a=true;
		try {webDriver.findElement(By.xpath("//p[text()='Setup your 'and text()=' family devices']"));}
		catch(NoSuchElementException e){a=false;
		test3.fail("Setup your family devices text not present");}
		if(a==true){test3.pass("Setup your family devices text present");}
		
		a=true;
		try {webDriver.findElement(By.xpath("//ul[@class='get_started_ul']/li[4]"));
		...
		a=true;
		try {webDriver.findElement(By.xpath("//p[text()='Monitor online 'and text()=' activity']"));}
		catch(NoSuchElementException e){a=false;
	...
	public void a5_section4() throws InterruptedException
	  {
		...
		try {webDriver.findElement(By.xpath("//*[text()='iPhone Parental Controls Installation Video']"));}
		catch(NoSuchElementException e){a=false;
		test4.fail("Section title is not correct");}
		if(a==true){test4.pass("Section title is correct");} 
		
		a=true;
		try {webDriver.findElement(By.xpath("//*[text()='Mobicip - #1 Rated Parental Controls for Apple iPhone']"));}
		catch(NoSuchElementException e){a=false;
		test4.fail("Section sub title is not correct");}
		if(a==true){test4.pass("Section sub title is correct");} 
		
		a=true;
		try {webDriver.findElement(By.xpath("//div[@class='child_setup_video_container']/iframe"));}
		catch(NoSuchElementException e){a=false;
	...
	public void a6_section5() throws InterruptedException
	  {
		...
		try {webDriver.findElement(By.xpath("//*[text()='Why Mobicip Parental Control App for Your Child’s iPhone?']"));}
		catch(NoSuchElementException e){a=false;
		test5.fail("Section title is not correct");}
		if(a==true){test5.pass("Section title is correct");} 
		
		try {webDriver.findElement(By.xpath("//div[@class='content_container iphone_container'][1]/div/div[1]"));
		...
		try {webDriver.findElement(By.xpath("//*[text()='Voted #1 Parent-Approved and Top Rated']"));}
		catch(NoSuchElementException e){a=false;
		test5.fail("Section title is not correct");}
		if(a==true){test5.pass("Section title is correct");} 
		
		a=true;
		try {webDriver.findElement(By.xpath("//div[@class='content_container iphone_container'][2]/div/div[1]"));
		...
		a=true;
		try {webDriver.findElement(By.xpath("//div[@class='stats_counters']/div[1]"));
		...
		String question = webDriver.findElement(By.xpath("//ul[@class='question_wrapper faq_container four-layout']/li[1]/h3")).getText();
		...
		String answer = webDriver.findElement(By.xpath("//ul[@class='question_wrapper faq_container four-layout']/li[1]/p")).getText();
		...
		String question1 = webDriver.findElement(By.xpath("//ul[@class='question_wrapper faq_container four-layout']/li[2]/h3")).getText();
		...
		String answer1 = webDriver.findElement(By.xpath("//ul[@class='question_wrapper faq_container four-layout']/li[2]/p")).getText();
		...
		String question2 = webDriver.findElement(By.xpath("//ul[@class='question_wrapper faq_container four-layout']/li[3]/h3")).getText();
		...
		String answer2 = webDriver.findElement(By.xpath("//ul[@class='question_wrapper faq_container four-layout']/li[3]/p")).getText();		
		...
		String question3 = webDriver.findElement(By.xpath("//ul[@class='question_wrapper faq_container four-layout']/li[4]/h3")).getText();
		...
		String answer3 = webDriver.findElement(By.xpath("//ul[@class='question_wrapper faq_container four-layout']/li[4]/p")).getText();
	...
	public void a7_section6() throws InterruptedException
	  {
		...
		boolean a=true;
		try {webDriver.findElement(By.xpath("//section[@class='faq_form_section']"));}
	    catch(NoSuchElementException e){a=false;
	...
	public void b1_iPadPage() throws InterruptedException
	  {
		...
		boolean a=true;
		try {webDriver.findElement(By.xpath("/html/body/div[1]/div/footer/div[2]/div/div[1]/div[1]/div[1]/ul/li[2]/a")).click();}
		catch(NoSuchElementException e){a=false;
	...
	public void b2_section1() throws InterruptedException
	  {
		...
		boolean a=true;
		try {webDriver.findElement(By.xpath("//*[text()='Smart iPad Parental Controls for Frazzled Parents']"));}
		catch(NoSuchElementException e){a=false;
		test7.fail("Section title is not correct");}
		if(a==true){test7.pass("Section title is correct");}   	
	 	
		a=true;
		try {webDriver.findElement(By.xpath("//*[text()='Don’t let the iPad babysit your chilwebDriver. Schedule screen time and instant-lock the iPad from your phone.']"));}
		catch(NoSuchElementException e){a=false;
	...
	public void b3_section2() throws InterruptedException
	  {
		...
		boolean a=true;
		try {webDriver.findElement(By.xpath("//*[text()='Cultivate Good Digital Citizenship & Etiquette']"));}
		catch(NoSuchElementException e){a=false;
		...
		a=true;
		try {webDriver.findElement(By.xpath("//ul[@class='sub_features_ul']/li[1]/p/strong/a")).click();}
		catch(NoSuchElementException e){a=false;
		...
		a=true;
		try {webDriver.findElement(By.xpath("//*[text()='Schedule & Limit Screen Time']"));}
		catch(NoSuchElementException e){a=false;
		...
		if(f3.equals("Set healthy time limits for how and when the iPad is usewebDriver."))
		{test8.pass("sub text correct");}
		else{test8.fail("sub text not correct");}
		
		a=true;
		try {webDriver.findElement(By.xpath("//ul[@class='sub_features_ul']/li[2]/p/strong/a")).click();}
		catch(NoSuchElementException e){a=false;
		...
		a=true;
		try {webDriver.findElement(By.xpath("//*[text()='Get alerted on risky interactions on Facebook & Instagram.']"));}
		catch(NoSuchElementException e){a=false;
		...
		a=true;
		try {webDriver.findElement(By.xpath("//ul[@class='sub_features_ul']/li[4]/p/strong/a")).click();}
		catch(NoSuchElementException e){a=false;
		...
		a=true;
		try {webDriver.findElement(By.xpath("//*[text()='Completely block distracting, inappropriate or addictive games and apps.']"));}
		catch(NoSuchElementException e){a=false;
		test8.fail("sub text not correct");}
		if(a==true){test8.pass("sub text correct");}
		...
		a=true;
		try {webDriver.findElement(By.xpath("//ul[@class='sub_features_ul']/li[5]/p/strong/a")).click();}
		catch(NoSuchElementException e){a=false;
		test8.fail("Screentime page redirects failed");}
		if(a==true){test8.pass("Screentime page redirect passed");}
		TimeUnit.SECONDS.sleep(1);
		...
		a=true;
		try {webDriver.findElement(By.xpath("//*[text()='Child dashboard shows how they spend their time online every day']"));}
		catch(NoSuchElementException e){a=false;
		test8.fail("sub text not correct");}
		if(a==true){test8.pass("sub text correct");}	
	...
	public void b4_section3() throws InterruptedException
	  {
		...
		boolean a=true;
		try {webDriver.findElement(By.xpath("//*[text()='Parental Controls is Anything But Easy.']"));}
		catch(NoSuchElementException e){a=false;
	...
	public void b5_section4() throws InterruptedException
	  {
		...
		boolean a=true;
		try {webDriver.findElement(By.xpath("//*[text()='Watch the Video Walkthrough']"));}
		catch(NoSuchElementException e){a=false;
		test10.fail("Section title is not correct");}
		if(a==true){test10.pass("Section title is correct");} 
		
		a=true;
		try {webDriver.findElement(By.xpath("//*[text()='Parental Controls & Family Locator for Apple iPads']"));}
		catch(NoSuchElementException e){a=false;
	...
	public void b6_section5() throws InterruptedException
	  {
		...
		try {webDriver.findElement(By.xpath("//*[text()='#1 Rated Parental Control Software for Apple Devices']"));}
		catch(NoSuchElementException e){a=false;
		test11.fail("Section title is not correct");}
		if(a==true){test11.pass("Section title is correct");} 
		
		String question1 = webDriver.findElement(By.xpath("//ul[@class='question_wrapper faq_container three-layout']/li[1]/h3")).getText();
		...
		String answer1 = webDriver.findElement(By.xpath("//ul[@class='question_wrapper faq_container three-layout']/li[1]/p")).getText();
		if(answer1.equals("Yes, you can. First, set up Mobicip in Parent Mode on your Android device, then set up Mobicip in Child Mode on your child's iPawebDriver. With Mobicip parental controls , parents can monitor their child's iPhones, iPads, Android phones/tablets, Kindle Fire, Mac, Windows devices or Chromebooks from any device of their choice."))
		{test11.pass("Answer 1 correct");}
		else{test11.fail("Answer 1 not correct");}
		
		String question2 = webDriver.findElement(By.xpath("//ul[@class='question_wrapper faq_container three-layout']/li[2]/h3")).getText();
		if(question2.equals("Can my child uninstall Mobicip from iOS devices?"))
		{test11.pass("Question 2 correct");}
		else{test11.fail("Question 2 not correct");}
		
		String answer2 = webDriver.findElement(By.xpath("//ul[@class='question_wrapper faq_container three-layout']/li[2]/p")).getText();		
		if(answer2.equals("All parental control solutions available in the market today can be uninstalled or disabled in one way or another. But while Mobicip can be partially disabled on iOS devices, parents will be immediately notified when their child's device isn't fully protected by Mobicip. This allows parents to be one step ahead of tech-savvy kids."))
		{test11.pass("Answer 2 correct");}
		else{test11.fail("Answer 2 not correct");}
		
		String question3 = webDriver.findElement(By.xpath("//ul[@class='question_wrapper faq_container three-layout']/li[3]/h3")).getText();
		...
		String answer3 = webDriver.findElement(By.xpath("//ul[@class='question_wrapper faq_container three-layout']/li[3]/p")).getText();
		if(answer3.equals("Mobicip allows parents to filter videos, block inappropriate video content and set YouTube parental controls on the iPawebDriver. The latest version of Mobicip works using VPN technology that allows it to filter videos directly on the Youtube app. In addition, Mobicip already filters videos on the YouTube website."))
	...
	public void c1_AndroidPage() throws InterruptedException
	  {
		...
		boolean a=true;
		try {webDriver.findElement(By.xpath("/html/body/div[1]/div/footer/div[2]/div/div[1]/div[1]/div[1]/ul/li[3]/a")).click();}
		catch(NoSuchElementException e){a=false;
	...
	public void c2_section1() throws InterruptedException
	  {
		...
		boolean a=true;
		try {webDriver.findElement(By.xpath("//*[text()='Android Parental Controls for Busy & Involved Parents']"));}
		catch(NoSuchElementException e){a=false;
		test13.fail("Section title is not correct");}
		if(a==true){test13.pass("Section title is correct");}   	
	 	
		a=true;
		try {webDriver.findElement(By.xpath("//*[text()='Big Tech loves to keeps your child engaged 24x7. Smart parents like you know better.']"));}
		catch(NoSuchElementException e){a=false;
	...
	public void c3_section2() throws InterruptedException
	  {
		...
		boolean a=true;
		try {webDriver.findElement(By.xpath("//*[text()='Keep in Touch With Your Family's Digital Life']"));}
		catch(NoSuchElementException e){a=false;
		...
		a=true;
		try {webDriver.findElement(By.xpath("//*[text()='Get alerted on risky interactions on Facebook, Instagram & Snapchat']"));}
		catch(NoSuchElementException e){a=false;
		...
		a=true;
		try {webDriver.findElement(By.xpath("//ul[@class='sub_features_ul']/li[6]/p/strong/a")).click();}
		catch(NoSuchElementException e){a=false;
		test14.fail("Screentime page redirects failed");}
		if(a==true){test14.pass("Screentime page redirect passed");}
		TimeUnit.SECONDS.sleep(1);
	...
	public void c4_section3() throws InterruptedException
	  {
		...
		boolean a=true;
		try {webDriver.findElement(By.xpath("//*[text()='Parental Control is Easier Said than Done.']"));}
		catch(NoSuchElementException e){a=false;
	...
	public void c5_section4() throws InterruptedException
	  {
		...
		a=true;
		try {webDriver.findElement(By.xpath("//*[text()='Android Parental Controls']"));}
		catch(NoSuchElementException e){a=false;
		test16.fail("Section sub title is not correct");}
		if(a==true){test16.pass("Section sub title is correct");} 
		
		a=true;
		try {webDriver.findElement(By.xpath("//div[@class='video_container']/iframe"));}
		catch(NoSuchElementException e){a=false;
	...
	public void d1_kindlePage() throws InterruptedException
	  {
		...
		boolean a=true;
		try {webDriver.findElement(By.xpath("/html/body/div[1]/div/footer/div[2]/div/div[1]/div[1]/div[1]/ul/li[4]/a")).click();}
		catch(NoSuchElementException e){a=false;
	...
	public void d2_section1() throws InterruptedException
	  {
		...
		boolean a=true;
		try {webDriver.findElement(By.xpath("//*[text()='Universal Kindle Fire Parental Controls for Busy Parents']"));}
		catch(NoSuchElementException e){a=false;
		test19.fail("Section title is not correct");}
		if(a==true){test19.pass("Section title is correct");}   	
	 	
		a=true;
		try {webDriver.findElement(By.xpath("//*[text()='The Kindle Fire is One of the Best Readers, but You Know Too Much of a Good Thing May Not be as GoowebDriver.']"));}
		catch(NoSuchElementException e){a=false;
	...
	public void d3_section2() throws InterruptedException
	  {
		...
		boolean a=true;
		try {webDriver.findElement(By.xpath("//*[text()='Help Digital Kids Learn to be Responsible']"));}
		catch(NoSuchElementException e){a=false;
		...
		a=true;
		try {webDriver.findElement(By.xpath("//ul[@class='sub_features_ul']/li[1]/p/a")).click();}
		catch(NoSuchElementException e){a=false;
		...
		a=true;
		try {webDriver.findElement(By.xpath("//ul[@class='sub_features_ul']/li[2]/p/a")).click();}
		catch(NoSuchElementException e){a=false;
		...
		a=true;
		try {webDriver.findElement(By.xpath("//ul[@class='sub_features_ul']/li[4]/p/a")).click();}
		catch(NoSuchElementException e){a=false;
		...
		a=true;
		try {webDriver.findElement(By.xpath("//ul[@class='sub_features_ul']/li[6]/p/a")).click();}
		catch(NoSuchElementException e){a=false;
		test20.fail("Screentime page redirects failed");}
		if(a==true){test20.pass("Screentime page redirect passed");}
		TimeUnit.SECONDS.sleep(1);
	...
	public void d4_section3() throws InterruptedException
	  {
		...
		boolean a=true;
		try {webDriver.findElement(By.xpath("//*[text()='Parental Controls is Tough. So Let's Get Going.']"));}
		catch(NoSuchElementException e){a=false;
	...
	public void e1_MacPage() throws InterruptedException
	  {
		...
		boolean a=true;
		try {webDriver.findElement(By.xpath("/html/body/div[1]/div/footer/div[2]/div/div[1]/div[1]/div[1]/ul/li[5]/a")).click();}
		catch(NoSuchElementException e){a=false;
	...
	public void e2_section1() throws InterruptedException
	  {
		...
		boolean a=true;
		try {webDriver.findElement(By.xpath("//*[text()='All-in-one Mac & MacBook Parental Controls for Busy Parents']"));}
		catch(NoSuchElementException e){a=false;
		test25.fail("Section title is not correct");}
		if(a==true){test25.pass("Section title is correct");}   	
	 	
		a=true;
		try {webDriver.findElement(By.xpath("//*[text()='Filter inappropriate websites, limit screen time and encourage responsible online behaviour.']"));}
		catch(NoSuchElementException e){a=false;
	...
	public void e3_section2() throws InterruptedException
	  {
		...
		boolean a=true;
		try {webDriver.findElement(By.xpath("//*[text()='Stay Involved and Be Informed to be Worry-Free.']"));}
		catch(NoSuchElementException e){a=false;
		...
		a=true;
		try {webDriver.findElement(By.xpath("//ul[@class='sub_features_ul']/li[3]/p/a")).click();}
		catch(NoSuchElementException e){a=false;
	...
	public void e4_section3() throws InterruptedException
	  {
		...
		boolean a=true;
		try {webDriver.findElement(By.xpath("//*[text()='Setting Up Parental Controls Takes a Lot of Hard Work']"));}
		catch(NoSuchElementException e){a=false;
	...
	public void e6_section5() throws InterruptedException
	  {
		...
		String answer1 = webDriver.findElement(By.xpath("//ul[@class='question_wrapper faq_container three-layout']/li[1]/p")).getText();
		if(answer1.equals("Mobicip's most popular parental controls for Mac OS lets you block inappropriate web content before it can be viewewebDriver. You can also schedule allowed screen time and instantly lock the device for quality family time. Parents can now manage all settings on Mac, Windows, iOS and Android devices for everyone in the family through a single parent dashboarwebDriver."))
	...
	public void f1_WindowsPage() throws InterruptedException
	  {
		...
		boolean a=true;
		try {webDriver.findElement(By.xpath("/html/body/div[1]/div/footer/div[2]/div/div[1]/div[1]/div[1]/ul/li[6]/a")).click();}
		catch(NoSuchElementException e){a=false;
	...
	public void f2_section1() throws InterruptedException
	  {
		...
		boolean a=true;
		try {webDriver.findElement(By.xpath("//*[text()='Smart Windows Parental Controls for Super-busy Parents']"));}
		catch(NoSuchElementException e){a=false;
		test31.fail("Section title is not correct");}
		if(a==true){test31.pass("Section title is correct");}   	
	 	
		a=true;
		try {webDriver.findElement(By.xpath("//*[text()='Stay involved and informed about your family's digital footprint, anytime anywhere']"));}
		catch(NoSuchElementException e){a=false;
	...
	public void f3_section2() throws InterruptedException
	  {
		...
		boolean a=true;
		try {webDriver.findElement(By.xpath("//*[text()='Your Peace of Mind Matters. Be in the Know.']"));}
		catch(NoSuchElementException e){a=false;
	...
	public void f4_section3() throws InterruptedException
	  {
		...
		boolean a=true;
		try {webDriver.findElement(By.xpath("//*[text()='Yes, Setting Up Parental Controls is a Challenge']"));}
		catch(NoSuchElementException e){a=false;
	...
	public void g1_ChromebookPage() throws InterruptedException
	  {
		...
		boolean a=true;
		try {webDriver.findElement(By.xpath("/html/body/div[1]/div/footer/div[2]/div/div[1]/div[1]/div[1]/ul/li[7]/a")).click();}
		catch(NoSuchElementException e){a=false;
	...
	public void g2_section1() throws InterruptedException
	  {
		...
		boolean a=true;
		try {webDriver.findElement(By.xpath("//*[text()='Chromebook Parental Controls for Tiger Parents']"));}
		catch(NoSuchElementException e){a=false;
		test37.fail("Section title is not correct");}
		if(a==true){test37.pass("Section title is correct");}   	
	 	
		a=true;
		try {webDriver.findElement(By.xpath("//*[text()='Secure the Chromebook and accompany your children as they embark on their digital journey.']"));}
		catch(NoSuchElementException e){a=false;
	...
	public void g3_section2() throws InterruptedException
	  {
		...
		boolean a=true;
		try {webDriver.findElement(By.xpath("//*[text()='Stay one step ahead of Big Tech with a watchful eye']"));}
		catch(NoSuchElementException e){a=false;
	...
	public void g4_section3() throws InterruptedException
	  {
		...
		boolean a=true;
		try {webDriver.findElement(By.xpath("//*[text()='Setting Up Parental Controls is Not for the Faint of Heart']"));}
		catch(NoSuchElementException e){a=false;
