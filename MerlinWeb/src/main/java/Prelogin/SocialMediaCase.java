	...
	public void beforeTest() 
	  {
		...
		spark = new ExtentSparkReporter("TestReports\\PreLoginTest\\SocialMediaConnect\\SocialMediaConnect.html");
	...
	public void a1_SocialLinks() throws InterruptedException
	  {
		...
		boolean a=true;
		try {webDriver.findElement(By.xpath("//a[@class='icon_social facebook' and @href='https://www.facebook.com/mobicip']"));}
		...
		a=true;
		try {webDriver.findElement(By.xpath("//a[@class='icon_social twitter' and @href='https://www.twitter.com/mobicip']"));}
	    catch(NoSuchElementException e){a=false;
	    ...
	    a=true;
		try {webDriver.findElement(By.xpath("//a[@class='icon_social linkedin' and @href='https://www.linkedin.com/company/mobicip']"));}
	    catch(NoSuchElementException e){a=false;
	    ...
	    a=true;
		try {webDriver.findElement(By.xpath("//a[@class='icon_social instagram' and @href='https://www.instagram.com/Mobicip_onlinesafety/']"));}
	    catch(NoSuchElementException e){a=false;
	    ...
	    a=true;
		try {webDriver.findElement(By.xpath("//a[@class='icon_social youtube' and @href='https://www.youtube.com/user/mobicip/featured']"));}
	    catch(NoSuchElementException e){a=false;
	...
	public void a2_Facebook() throws InterruptedException
	  {
		...
		webDriver.findElement(By.xpath("//a[@class='icon_social facebook' and @href='https://www.facebook.com/mobicip']")).click();
		...
		new WebDriverWait(webDriver,Duration.ofSeconds(20)).until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//h1[contains(text(),'Mobicip - Parental Control App')]")));
		boolean a=true;
		try {webDriver.findElement(By.xpath("//h1[contains(text(),'Mobicip - Parental Control App')]"));}
	    catch(NoSuchElementException e){a=false;
	...
	public void a3_Instagram() throws InterruptedException
	  {
		...
		//Click the link which opens in a new window
		webDriver.findElement(By.xpath("//a[@class='icon_social instagram' and @href='https://www.instagram.com/Mobicip_onlinesafety/']")).click();
		...
		//Wait for the new tab to finish loading content
		new WebDriverWait(webDriver,Duration.ofSeconds(20)).until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//h2[text()='mobicip_onlinesafety']")));
		boolean a=true;
		try {webDriver.findElement(By.xpath("//h2[text()='mobicip_onlinesafety']"));}
	    catch(NoSuchElementException e){a=false;
	...
	public void a4_Twitter() throws InterruptedException
	  {
		...
		//Click the link which opens in a new window
		webDriver.findElement(By.xpath("//a[@class='icon_social twitter' and @href='https://www.twitter.com/mobicip']")).click();
		...
		//Wait for the new tab to finish loading content
		new WebDriverWait(webDriver,Duration.ofSeconds(20)).until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//span[text()='Sign in to X']")));
		boolean a=true;
		try {webDriver.findElement(By.xpath("//span[text()='Sign in to X']"));}
	    catch(NoSuchElementException e){a=false;
	...
	public void a5_Linkedin() throws InterruptedException
	  {
		...
		//Click the link which opens in a new window
		webDriver.findElement(By.xpath("//a[@class='icon_social linkedin' and @href='https://www.linkedin.com/company/mobicip']")).click();
		...
		//Wait for the new tab to finish loading content
		new WebDriverWait(webDriver,Duration.ofSeconds(20)).until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//h1[contains(text(),'Mobicip')]")));
		boolean a=true;
		try {webDriver.findElement(By.xpath("//h1[contains(text(),'Mobicip')]"));}
	    catch(NoSuchElementException e){a=false;
	...
	public void a6_Youtube() throws InterruptedException
	  {
		...
		//Click the link which opens in a new window
		webDriver.findElement(By.xpath("//a[@class='icon_social youtube' and @href='https://www.youtube.com/user/mobicip/featured']")).click();
		...
		//Wait for the new tab to finish loading content
		new WebDriverWait(webDriver,Duration.ofSeconds(20)).until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//yt-formatted-string[text()='Mobicip Parental Controls']")));
		boolean a=true;
		try {webDriver.findElement(By.xpath("//yt-formatted-string[text()='Mobicip Parental Controls']"));}
	    catch(NoSuchElementException e){a=false;
