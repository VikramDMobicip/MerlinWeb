...
public class HomePage extends BrowserSetupClass{
	  ...
	  //Report setup
		...
		public void beforeTest() 
		  {
			...
			spark = new ExtentSparkReporter("TestReports\\PreLoginTest\\HomeTest\\HomeReport.html");
		...
		public void a2_Section1() throws InterruptedException 
		{
			...
			boolean a=true;
			try {webDriver.findElement(By.xpath("//*[text()='Smart Parental Control App for Busy Parents']"));}
			catch(NoSuchElementException e){a=false;
			test1.fail("Section 1 - Main title text is not correct");}
			if(a==true){test1.pass("Section 1 - Main title text is correct");} 
		    
			a=true;
			try {webDriver.findElement(By.xpath("//*[text()='Your Peace of Mind Matters']"));}
			catch(NoSuchElementException e){a=false;
			test1.fail("Sub title is not correct");}
			if(a==true){test1.pass("Sub title is correct");}
			
			a=true;
			try {webDriver.findElement(By.xpath("//*[text()='Limit screen time, filter internet, monitor social media, track location, and more.']"));}
			catch(NoSuchElementException e){a=false;
			test1.fail("Description is not correct");}
			if(a==true){test1.pass("Description is correct");}
			
			a=true;
			try {webDriver.findElement(By.xpath("//div[@class='banner_content_container']/div[2]/a"));}
			catch(NoSuchElementException e){a=false;
			test1.fail("Start free trial button not present");}
			if(a==true){test1.pass("Start free trial button present");}
			
			a=true;
			try {webDriver.findElement(By.xpath("//div[@class='banner_content_container']/div[2]/a")).click();}
			catch(NoSuchElementException e){a=false;
			...
			a=true;
			try {webDriver.findElement(By.xpath("//*[text()='Protects iOS, Android, macOS, Windows, Chromebook & Kindle']"));}
			catch(NoSuchElementException e){a=false;
		...
		public void a3_Section2() throws InterruptedException 
		{
			...
			boolean a=true;
			try {webDriver.findElement(By.xpath("//*[text()='Protect Your Family from Big Tech�s Influence']"));}
			catch(NoSuchElementException e){a=false;
			test2.fail("Section 2 - Title text is not correct");}
			if(a==true){test2.pass("Section 2 - Title text is correct");} 
		    
			String li1 = webDriver.findElement(By.xpath("//ul[@class='home_main_feature_wrapper']/li[1]/a/span[2]")).getText();
			if(li1.equals("Limit"))
			{test2.pass("1.Limit title is correct");}
			else{test2.fail("1.Limit title is not correct");}
			
			a=true;
			try {webDriver.findElement(By.xpath("//ul[@class='home_main_feature_wrapper']/li[1]/a/span[1]"));}
			catch(NoSuchElementException e){a=false;
			...
			a=true;
			try {webDriver.findElement(By.xpath("//ul[@class='home_main_feature_wrapper']/li[1]/a")).click();}
			catch(NoSuchElementException e){a=false;
			...
			String li2 = webDriver.findElement(By.xpath("//ul[@class='home_main_feature_wrapper']/li[2]/a/span[2]")).getText();
			if(li2.equals("Protect"))
			{test2.pass("2.Protect title is correct");}
			else{test2.fail("2.Protect title is not correct");}
			
			a=true;
			try {webDriver.findElement(By.xpath("//ul[@class='home_main_feature_wrapper']/li[2]/a/span[1]"));}
			catch(NoSuchElementException e){a=false;
			test2.fail("Icon is not present");}
			if(a==true){test2.pass("Icon is present");}
			...
			a=true;
			try {webDriver.findElement(By.xpath("//ul[@class='home_main_feature_wrapper']/li[2]/a")).click();}
			catch(NoSuchElementException e){a=false;
			...
			String li3 = webDriver.findElement(By.xpath("//ul[@class='home_main_feature_wrapper']/li[3]/a/span[2]")).getText();
			if(li3.equals("Monitor"))
			{test2.pass("3.Monitor title is correct");}
			else{test2.fail("3.Monitor title is not correct");}
			
			a=true;
			try {webDriver.findElement(By.xpath("//ul[@class='home_main_feature_wrapper']/li[3]/a/span[1]"));}
			catch(NoSuchElementException e){a=false;
			test2.fail("Icon is not present");}
			if(a==true){test2.pass("Icon is present");}
			...
			a=true;
			try {webDriver.findElement(By.xpath("//ul[@class='home_main_feature_wrapper']/li[3]/a")).click();}
			catch(NoSuchElementException e){a=false;
			...
			String li4 = webDriver.findElement(By.xpath("//ul[@class='home_main_feature_wrapper']/li[4]/a/span[2]")).getText();
			if(li4.equals("Collaborate"))
			{test2.pass("4.Collaborate title is correct");}
			else{test2.fail("4.Collaborate title is not correct");}
			
			a=true;
			try {webDriver.findElement(By.xpath("//ul[@class='home_main_feature_wrapper']/li[4]/a/span[1]"));}
			catch(NoSuchElementException e){a=false;
			test2.fail("Icon is not present");}
			if(a==true){test2.pass("Icon is present");}
			...
			a=true;
			try {webDriver.findElement(By.xpath("//ul[@class='home_main_feature_wrapper']/li[4]/a")).click();}
			catch(NoSuchElementException e){a=false;
		...
		public void a4_Section3() throws InterruptedException 
		{
			...
			boolean a=true;
			try {webDriver.findElement(By.xpath("//*[text()='More Than 2 Million Parents Love Mobicip']"));}
			catch(NoSuchElementException e){a=false;
			...
			if(li1.equals("It's a great app for kids. It keeps track of everything the child does including the amount of time spent in different apps and when settings are changewebDriver. It's safe when I can mess around in the kitchen and still keep my kids safe from toxic things."))
			{test3.pass("1. Quote is correct");}
			else{test3.fail("1. Quote is not correct");}
			
			String li11 = webDriver.findElement(By.xpath("//div[@class='review_wrapper']/div[2]/ul/li[1]/div/p")).getText();
			if(li11.equals("Mobicip Dad, California"))
			{test3.pass("Name text is correct");}
			else{test3.fail("Name text is not correct");}
			
			String li12 = webDriver.findElement(By.xpath("//div[@class='review_wrapper']/div[2]/ul/li[1]/div/div/p")).getText();
			...
			a=true;
			try {
			webDriver.findElement(By.xpath("//div[@class='review_wrapper']/div[2]/ul/li[1]/div/div/div/span[1]"));
			webDriver.findElement(By.xpath("//div[@class='review_wrapper']/div[2]/ul/li[1]/div/div/div/span[2]"));
			webDriver.findElement(By.xpath("//div[@class='review_wrapper']/div[2]/ul/li[1]/div/div/div/span[3]"));
			webDriver.findElement(By.xpath("//div[@class='review_wrapper']/div[2]/ul/li[1]/div/div/div/span[4]"));
			webDriver.findElement(By.xpath("//div[@class='review_wrapper']/div[2]/ul/li[1]/div/div/div/span[5]"));
			}
			catch(NoSuchElementException e){a=false;
			...
			String li21 = webDriver.findElement(By.xpath("//div[@class='review_wrapper']/div[2]/ul/li[2]/div/p")).getText();
			if(li21.equals("Mobicip Mom, North Carolina"))
			{test3.pass("Name text is correct");}
			else{test3.fail("Name text is not correct");}
			
			String li22 = webDriver.findElement(By.xpath("//div[@class='review_wrapper']/div[2]/ul/li[2]/div/div/p")).getText();
			...
			a=true;
			try {
			webDriver.findElement(By.xpath("//div[@class='review_wrapper']/div[2]/ul/li[2]/div/div/div/span[1]"));
			webDriver.findElement(By.xpath("//div[@class='review_wrapper']/div[2]/ul/li[2]/div/div/div/span[2]"));
			webDriver.findElement(By.xpath("//div[@class='review_wrapper']/div[2]/ul/li[2]/div/div/div/span[3]"));
			webDriver.findElement(By.xpath("//div[@class='review_wrapper']/div[2]/ul/li[2]/div/div/div/span[4]"));
			webDriver.findElement(By.xpath("//div[@class='review_wrapper']/div[2]/ul/li[2]/div/div/div/span[5]"));
			}
			catch(NoSuchElementException e){a=false;
			test3.fail("Rating icon is not present");}
			if(a==true){test3.pass("Rating icon is present");}
		...
		public void a6_Section5() throws InterruptedException 
		{
			...
			String l1 = webDriver.findElement(By.xpath("//div[@class='home_feature_wrapper limit right_image']/ul/li/div[1]/span")).getText();
			if(l1.equals("Limit"))
			{test5.pass("1. Limit tag is correct");}
			else{test5.fail("1. Limit tag is not correct");}
			
			String l2 = webDriver.findElement(By.xpath("//div[@class='home_feature_wrapper limit right_image']/ul/li/div[1]/h2")).getText();
			...
			String l3 = webDriver.findElement(By.xpath("//div[@class='home_feature_wrapper limit right_image']/ul/li/div[1]/div[1]/ul/li[1]/a/h3/span")).getText();
			if(l3.equals("Screen Time"))
			{test5.pass("1.Screen time - title is correct");}
			else{test5.fail("1.Screen time - title is not correct");}
			
			String l4 = webDriver.findElement(By.xpath("//div[@class='home_feature_wrapper limit right_image']/ul/li/div[1]/div[1]/ul/li[1]/a/p[1]")).getText();
			...
			String l5 = webDriver.findElement(By.xpath("//div[@class='home_feature_wrapper limit right_image']/ul/li/div[1]/div[1]/ul/li[1]/a/p[2]/span")).getText();
			if(l5.equals("Learn More"))
			{test5.pass("Learn more is present");}
			else{test5.fail("Learn more is not present");}
			
			boolean a=true;
			try {webDriver.findElement(By.xpath("//div[@class='home_feature_wrapper limit right_image']/ul/li/div[1]/div[1]/ul/li[1]/a")).click();}
			catch(NoSuchElementException e){a=false;
			...
			String l6 = webDriver.findElement(By.xpath("//div[@class='home_feature_wrapper limit right_image']/ul/li/div[1]/div[1]/ul/li[2]/a/h3/span")).getText();
			if(l6.equals("App Limits"))
			{test5.pass("2.Applimits - title is correct");}
			else{test5.fail("2.Applimits - title is correct");}
			
			String l7 = webDriver.findElement(By.xpath("//div[@class='home_feature_wrapper limit right_image']/ul/li/div[1]/div[1]/ul/li[2]/a/p[1]")).getText();
			if(l7.equals("Limit the time spent every day on social media, games and videos."))
			{test5.pass("Description is correct");}
			else{test5.fail("Description is not correct");}
			
			String l8 = webDriver.findElement(By.xpath("//div[@class='home_feature_wrapper limit right_image']/ul/li/div[1]/div[1]/ul/li[2]/a/p[2]/span")).getText();
			if(l8.equals("Learn More"))
			{test5.pass("Learn more is present");}
			else{test5.fail("Learn more is not present");}
			
			a=true;
			try {webDriver.findElement(By.xpath("//div[@class='home_feature_wrapper limit right_image']/ul/li/div[1]/div[1]/ul/li[2]/a")).click();}
			catch(NoSuchElementException e){a=false;
			test5.fail("Learn more link fails");}
			...
			String l9 = webDriver.findElement(By.xpath("//div[@class='home_feature_wrapper limit right_image']/ul/li/div[1]/div[1]/ul/li[3]/a/h3/span")).getText();
			if(l9.equals("Schedules"))
			{test5.pass("3.Schedules - title is correct");}
			else{test5.fail("3.Schedules - title is correct");}
			
			String l10 = webDriver.findElement(By.xpath("//div[@class='home_feature_wrapper limit right_image']/ul/li/div[1]/div[1]/ul/li[3]/a/p[1]")).getText();
			if(l10.equals("Create customized schedules for activities with access to specific apps and websites."))
			{test5.pass("Description is correct");}
			else{test5.fail("Description is not correct");}
			
			String l11 = webDriver.findElement(By.xpath("//div[@class='home_feature_wrapper limit right_image']/ul/li/div[1]/div[1]/ul/li[3]/a/p[2]/span")).getText();
			if(l11.equals("Learn More"))
			{test5.pass("Learn more is present");}
			else{test5.fail("Learn more is not present");}
			
			a=true;
			try {webDriver.findElement(By.xpath("//div[@class='home_feature_wrapper limit right_image']/ul/li/div[1]/div[1]/ul/li[3]/a")).click();}
			catch(NoSuchElementException e){a=false;
			test5.fail("Learn more link fails");}
			...
			a=true;
			try {webDriver.findElement(By.xpath("//div[@class='home_feature_wrapper limit right_image']/div/div[1]/picture"));}
			catch(NoSuchElementException e){a=false;
			test5.fail("Background Image not present");}
			if(a==true){test5.pass("Background Image present");}
			
			a=true;
			try {webDriver.findElement(By.xpath("//div[@class='home_feature_wrapper limit right_image']/div/div[2]/picture"));}
			catch(NoSuchElementException e){a=false;
			test5.fail("All 3 features image not present");}
			if(a==true){test5.pass("All 3 features image present");}
			
			a=true;
			try {webDriver.findElement(By.xpath("//div[@class='home_feature_wrapper limit right_image']/ul/li/div[1]/div[2]/a"));}
			catch(NoSuchElementException e){a=false;
			...
			a=true;
			try {webDriver.findElement(By.xpath("//div[@class='home_feature_wrapper limit right_image']/ul/li/div[1]/div[2]/a")).click();}
			catch(NoSuchElementException e){a=false;
		...
		public void a7_Section5() throws InterruptedException 
		{
			...
			String l1 = webDriver.findElement(By.xpath("//div[@class='home_feature_wrapper protect left_image']/ul/li/div[1]/span")).getText();
			if(l1.equals("Protect"))
			{test6.pass("2. Protect tag is correct");}
			else{test6.fail("2. Protect tag is not correct");}
			
			String l2 = webDriver.findElement(By.xpath("//div[@class='home_feature_wrapper protect left_image']/ul/li/div[1]/h2")).getText();
			...
			String l3 = webDriver.findElement(By.xpath("//div[@class='home_feature_wrapper protect left_image']/ul/li/div[1]/div[1]/ul/li[1]/a/h3/span")).getText();
			...
			String l4 = webDriver.findElement(By.xpath("//div[@class='home_feature_wrapper protect left_image']/ul/li/div[1]/div[1]/ul/li[1]/a/p[1]")).getText();
			...
			String l5 = webDriver.findElement(By.xpath("//div[@class='home_feature_wrapper protect left_image']/ul/li/div[1]/div[1]/ul/li[1]/a/p[2]/span")).getText();
			if(l5.equals("Learn More"))
			{test6.pass("Learn more is present");}
			else{test6.fail("Learn more is not present");}
			
			boolean a=true;
			try {webDriver.findElement(By.xpath("//div[@class='home_feature_wrapper protect left_image']/ul/li/div[1]/div[1]/ul/li[1]/a")).click();}
			catch(NoSuchElementException e){a=false;
			...
			String l6 = webDriver.findElement(By.xpath("//div[@class='home_feature_wrapper protect left_image']/ul/li/div[1]/div[1]/ul/li[2]/a/h3/span")).getText();
			if(l6.equals("App Blocker"))
			{test6.pass("2.AppBlocker - title is correct");}
			else{test6.fail("2.AppBlocker - title is not correct");}
			
			String l7 = webDriver.findElement(By.xpath("//div[@class='home_feature_wrapper protect left_image']/ul/li/div[1]/div[1]/ul/li[2]/a/p[1]")).getText();
			if(l7.equals("Block apps in social media, games, video and other categories."))
			{test6.pass("Description is correct");}
			else{test6.fail("Description is not correct");}
			
			String l8 = webDriver.findElement(By.xpath("//div[@class='home_feature_wrapper protect left_image']/ul/li/div[1]/div[1]/ul/li[2]/a/p[2]/span")).getText();
			if(l8.equals("Learn More"))
			{test6.pass("Learn more is present");}
			else{test6.fail("Learn more is not present");}
			...
			a=true;
			try {webDriver.findElement(By.xpath("//div[@class='home_feature_wrapper protect left_image']/div/div[1]/picture"));}
			catch(NoSuchElementException e){a=false;
			test6.fail("Background Image not present");}
			if(a==true){test6.pass("Background Image present");}
			
			a=true;
			try {webDriver.findElement(By.xpath("//div[@class='home_feature_wrapper protect left_image']/div/div[2]/picture"));}
			catch(NoSuchElementException e){a=false;
			test6.fail("All 3 features image not present");}
			if(a==true){test6.pass("All 3 features image present");}
			
			a=true;
			try {webDriver.findElement(By.xpath("//div[@class='home_feature_wrapper protect left_image']/ul/li/div[1]/div[2]/a"));}
			catch(NoSuchElementException e){a=false;
			...
			a=true;
			try {webDriver.findElement(By.xpath("//div[@class='home_feature_wrapper protect left_image']/ul/li/div[1]/div[2]/a")).click();}
			catch(NoSuchElementException e){a=false;
		...
		public void a8_Section5() throws InterruptedException 
		{
			...
			String l1 = webDriver.findElement(By.xpath("//div[@class='home_feature_wrapper monitor right_image']/ul/li/div[1]/span")).getText();
			if(l1.equals("Monitor"))
			{test7.pass("1. Monitor tag is correct");}
			else{test7.fail("1. Monitor tag is not correct");}
			
			String l2 = webDriver.findElement(By.xpath("//div[@class='home_feature_wrapper monitor right_image']/ul/li/div[1]/h2")).getText();
			if(l2.equals("Monitor online habits & intervene when alerted"))
			{test7.pass("Title is correct");}
			else{test7.fail("Title is not correct");}
			
			String l3 = webDriver.findElement(By.xpath("//div[@class='home_feature_wrapper monitor right_image']/ul/li/div[1]/div[1]/ul/li[1]/a/h3/span")).getText();
			if(l3.equals("Social Media"))
			{test7.pass("1.Social Media - title is correct");}
			else{test7.fail("1.Social Media - title is not correct");}
			
			String l4 = webDriver.findElement(By.xpath("//div[@class='home_feature_wrapper monitor right_image']/ul/li/div[1]/div[1]/ul/li[1]/a/p[1]")).getText();
			...
			String l5 = webDriver.findElement(By.xpath("//div[@class='home_feature_wrapper monitor right_image']/ul/li/div[1]/div[1]/ul/li[1]/a/p[2]/span")).getText();
			if(l5.equals("Learn More"))
			{test7.pass("Learn more is present");}
			else{test7.fail("Learn more is not present");}
			
			boolean a=true;
			try {webDriver.findElement(By.xpath("//div[@class='home_feature_wrapper monitor right_image']/ul/li/div[1]/div[1]/ul/li[1]/a")).click();}
			catch(NoSuchElementException e){a=false;
			...
			String l6 = webDriver.findElement(By.xpath("//div[@class='home_feature_wrapper monitor right_image']/ul/li/div[1]/div[1]/ul/li[2]/a/h3/span")).getText();
			if(l6.equals("Family Locator"))
			{test7.pass("2.Family Locator - title is correct");}
			else{test7.fail("2.Family Locator - title is correct");}
			
			String l7 = webDriver.findElement(By.xpath("//div[@class='home_feature_wrapper monitor right_image']/ul/li/div[1]/div[1]/ul/li[2]/a/p[1]")).getText();
			if(l7.equals("View live location. Create geofences to know when your child enters & leaves from frequented spots."))
			{test7.pass("Description is correct");}
			else{test7.fail("Description is not correct");}
			
			String l8 = webDriver.findElement(By.xpath("//div[@class='home_feature_wrapper monitor right_image']/ul/li/div[1]/div[1]/ul/li[2]/a/p[2]/span")).getText();
			if(l8.equals("Learn More"))
			{test7.pass("Learn more is present");}
			else{test7.fail("Learn more is not present");}
			
			a=true;
			try {webDriver.findElement(By.xpath("//div[@class='home_feature_wrapper monitor right_image']/ul/li/div[1]/div[1]/ul/li[2]/a")).click();}
			catch(NoSuchElementException e){a=false;
			test7.fail("Learn more link fails");}
			...
			String l9 = webDriver.findElement(By.xpath("//div[@class='home_feature_wrapper monitor right_image']/ul/li/div[1]/div[1]/ul/li[3]/a/h3/span")).getText();
			...
			String l10 = webDriver.findElement(By.xpath("//div[@class='home_feature_wrapper monitor right_image']/ul/li/div[1]/div[1]/ul/li[3]/a/p[1]")).getText();
			if(l10.equals("Keep track of how your children spend their time online."))
			{test7.pass("Description is correct");}
			else{test7.fail("Description is not correct");}
			
			String l11 = webDriver.findElement(By.xpath("//div[@class='home_feature_wrapper monitor right_image']/ul/li/div[1]/div[1]/ul/li[3]/a/p[2]/span")).getText();
			if(l11.equals("Learn More"))
			{test7.pass("Learn more is present");}
			else{test7.fail("Learn more is not present");}
			
			a=true;
			try {webDriver.findElement(By.xpath("//div[@class='home_feature_wrapper monitor right_image']/ul/li/div[1]/div[1]/ul/li[3]/a")).click();}
			catch(NoSuchElementException e){a=false;
			test7.fail("Learn more link fails");}
			...
			a=true;
			try {webDriver.findElement(By.xpath("//div[@class='home_feature_wrapper monitor right_image']/div/div[1]/picture"));}
			catch(NoSuchElementException e){a=false;
			test7.fail("Background Image not present");}
			if(a==true){test7.pass("Background Image present");}
			
			a=true;
			try {webDriver.findElement(By.xpath("//div[@class='home_feature_wrapper monitor right_image']/div/div[2]/picture"));}
			catch(NoSuchElementException e){a=false;
			test7.fail("All 3 features image not present");}
			if(a==true){test7.pass("All 3 features image present");}
			
			a=true;
			try {webDriver.findElement(By.xpath("//div[@class='home_feature_wrapper monitor right_image']/ul/li/div[1]/div[2]/a"));}
			catch(NoSuchElementException e){a=false;
			...
			a=true;
			try {webDriver.findElement(By.xpath("//div[@class='home_feature_wrapper monitor right_image']/ul/li/div[1]/div[2]/a")).click();}
			catch(NoSuchElementException e){a=false;
		...
		public void a9_Section5() throws InterruptedException 
		{
			...
			String l1 = webDriver.findElement(By.xpath("//div[@class='home_feature_wrapper collaborate left_image']/ul/li/div[1]/span")).getText();
			if(l1.equals("Collaborate"))
			{test8.pass("4. Collaborate tag is correct");}
			else{test8.fail("4. Collaborate tag is not correct");}
			
			String l2 = webDriver.findElement(By.xpath("//div[@class='home_feature_wrapper collaborate left_image']/ul/li/div[1]/h2")).getText();
			...
			String l3 = webDriver.findElement(By.xpath("//div[@class='home_feature_wrapper collaborate left_image']/ul/li/div[1]/div[1]/ul/li[1]/a/h3/span")).getText();
			...
			String l4 = webDriver.findElement(By.xpath("//div[@class='home_feature_wrapper collaborate left_image']/ul/li/div[1]/div[1]/ul/li[1]/a/p[1]")).getText();
			...
			String l5 = webDriver.findElement(By.xpath("//div[@class='home_feature_wrapper collaborate left_image']/ul/li/div[1]/div[1]/ul/li[1]/a/p[2]/span")).getText();
			if(l5.equals("Learn More"))
			{test8.pass("Learn more is present");}
			else{test8.fail("Learn more is not present");}
			
			boolean a=true;
			try {webDriver.findElement(By.xpath("//div[@class='home_feature_wrapper collaborate left_image']/ul/li/div[1]/div[1]/ul/li[1]/a")).click();}
			catch(NoSuchElementException e){a=false;
			...
			String l6 = webDriver.findElement(By.xpath("//div[@class='home_feature_wrapper collaborate left_image']/ul/li/div[1]/div[1]/ul/li[2]/a/h3/span")).getText();
			if(l6.equals("Guardians"))
			{test8.pass("2.Guardians - title is correct");}
			else{test8.fail("2.Guardians - title is not correct");}
			
			String l7 = webDriver.findElement(By.xpath("//div[@class='home_feature_wrapper collaborate left_image']/ul/li/div[1]/div[1]/ul/li[2]/a/p[1]")).getText();
			if(l7.equals("Share your digital parenting responsibilities with trusted others among your family and friends."))
			{test8.pass("Description is correct");}
			else{test8.fail("Description is not correct");}
			
			String l8 = webDriver.findElement(By.xpath("//div[@class='home_feature_wrapper collaborate left_image']/ul/li/div[1]/div[1]/ul/li[2]/a/p[2]/span")).getText();
			if(l8.equals("Learn More"))
			{test8.pass("Learn more is present");}
			else{test8.fail("Learn more is not present");}
			
			a=true;
			try {webDriver.findElement(By.xpath("//div[@class='home_feature_wrapper collaborate left_image']/ul/li/div[1]/div[1]/ul/li[2]/a")).click();}
			catch(NoSuchElementException e){a=false;
			test8.fail("Learn more link fails");}
			if(a==true){test8.pass("Learn more redirects to collaboration page");}
			TimeUnit.SECONDS.sleep(2);
			...
			a=true;
			try {webDriver.findElement(By.xpath("//div[@class='home_feature_wrapper collaborate left_image']/div/div[1]/picture"));}
			catch(NoSuchElementException e){a=false;
			test8.fail("Background Image not present");}
			if(a==true){test8.pass("Background Image present");}
			
			a=true;
			try {webDriver.findElement(By.xpath("//div[@class='home_feature_wrapper collaborate left_image']/div/div[2]/picture"));}
			catch(NoSuchElementException e){a=false;
			test8.fail("All 3 features image not present");}
			if(a==true){test8.pass("All 3 features image present");}
			
			a=true;
			try {webDriver.findElement(By.xpath("//div[@class='home_feature_wrapper collaborate left_image']/ul/li/div[1]/div[2]/a"));}
			catch(NoSuchElementException e){a=false;
		...
		public void b1_Section6() throws InterruptedException 
		{
			...
			boolean a=true;
			try {webDriver.findElement(By.xpath("//*[text()='Our Partners']"));}
			catch(NoSuchElementException e){a=false;
			test9.fail("Section 6 - Title text is not correct");}
			if(a==true){test9.pass("Section 6 - Title text is correct");} 
		    
			a=true;
			try {webDriver.findElement(By.xpath("//ul[@class='partner_section_ul']/li[1]//picture"));}
			catch(NoSuchElementException e){a=false;
			test9.fail("1.Verizon - Image not present");}
			if(a==true){test9.pass("1.Verizon - Image present");}
			
			a=true;
			try {webDriver.findElement(By.xpath("//ul[@class='partner_section_ul']/li[2]//picture"));}
			catch(NoSuchElementException e){a=false;
			test9.fail("2.Cyber Wise - Image not present");}
			if(a==true){test9.pass("2.Cyber Wise - Image present");}
			
			a=true;
			try {webDriver.findElement(By.xpath("//ul[@class='partner_section_ul']/li[3]//picture"));}
			catch(NoSuchElementException e){a=false;
