...
public class Features extends BrowserSetupClass {
    ...
    public void beforeTest()
    {
		...
		spark = new ExtentSparkReporter("TestReports\\TestFeatures\\reportFeatures.html");
	...
	public void a2_Featuresbutton()
	{
  		...
  		boolean a=true;
  		try {webDriver.findElement(By.xpath("//span[text()='Features']")).click();}
		...
		a=true;
  		try {webDriver.findElement(By.xpath("//span[text()='Screen Time Scheduler']"));
  		webDriver.findElement(By.xpath("//p[text()='Create schedules to limit screen ' and text()=' time & app usage']"));
  		webDriver.findElement(By.xpath("//span[text()='Social Media Monitor']"));
  		webDriver.findElement(By.xpath("//p[text()='Monitor social media & prevent ' and text()=' risky behavior']"));
  		...
  		webDriver.findElement(By.xpath("//p[text()='Keep track of how your children ' and text()=' spend their time online']"));
  		...
  		webDriver.findElement(By.xpath("//p[text()='Locate your children and set geo-boundaries to ensure their safety']"));
	...
	public void a3_Screentimepage()
	{
	    ...
	    //Header
  		boolean a=true;
  		try {webDriver.findElement(By.xpath("//span[@class='icon_menu']"));
		...
		//List of features
		a=true;
  		try {webDriver.findElement(By.xpath("//ul[@class='feature_ul']"));}
		catch(NoSuchElementException e){a=false;
			test.fail("Screen time page List of features is present");}
		if(a==true){test.pass("Screen time page List of features is present");}
		//Defination
		a=true;
  		try {webDriver.findElement(By.xpath("//h1[text()='SCREEN TIME']"));
  		webDriver.findElement(By.xpath("//span[text()='Schedule Screen Time & App Usage']"));
  		webDriver.findElement(By.xpath("//p[contains(text(),'Set daily schedules with restricted access to apps and websites. Limit daily screen time by category and lock the screens on demanwebDriver. View usage reports and adjust screen time allowances.')]"));}
		catch(NoSuchElementException e){a=false;
			test.fail("Screen time page Defination is incorrect");}
		if(a==true){test.pass("Screen time page Defination is correct");}
		//start free trail
		a=true;
  		try {webDriver.findElement(By.xpath("//div[@class='action_container']//a[@class='primary_button' and text()='Start Free Trial']"));}
		catch(NoSuchElementException e){a=false;
		...
		a=true;
  		try {webDriver.findElement(By.xpath("//h2[text()='Features of Mobicip Screen Time Scheduler']"));
  		webDriver.findElement(By.xpath("//h3[text()='Schedules']"));
  		webDriver.findElement(By.xpath("//p[contains(text(),'Set schedules for activities like school, homework and sleep to ensure productive learning and healthy habits. Block specific apps and websites, and manage screen time during a schedule.')]"));
  		webDriver.findElement(By.xpath("//h3[text()=' Daily Free Time Limit']"));
  		webDriver.findElement(By.xpath("//p[contains(text(),'Set daily screen time allowed for entertainment with access to games, social media and movies.')]"));
		...
		try {TimeUnit.SECONDS.sleep(3);} catch (InterruptedException e) {e.printStackTrace();}		
		a=true;
  		try {webDriver.findElement(By.xpath("//h2[text()='Why Limiting Screen Time is Important?']"));
  		webDriver.findElement(By.xpath("//p[@class='paragraph_content' and  contains(text(),' Kids are spending more time on screens than ever before.')]"));
  		webDriver.findElement(By.xpath("//a[contains(text(),'How To Bypass Screen Time: 12 Apple Parental Control Hacks')]"));
  		webDriver.findElement(By.xpath("//a[contains(text(),'Digital Detox - Old School is the New Cool')]"));}
  		catch(NoSuchElementException e){a=false;
		test.fail("Screen time page Importance is not present");}
  		...
  		try {TimeUnit.SECONDS.sleep(3);} catch (InterruptedException e) {e.printStackTrace();}		
  		//Effects
  		try {webDriver.findElement(By.xpath("//h2[text()='Effects of Screen Time on Sleep & Sight']"));
  		webDriver.findElement(By.xpath("//p[@class='paragraph_content' and  contains(text(),'The National Sleep Foundation recommends that you should stop using tablets & smartphones at least 30')]"));
		...
		test.fail("Screen time page Effects is not present");}
  		...
  		try {TimeUnit.SECONDS.sleep(3);} catch (InterruptedException e) {e.printStackTrace();}	
  		//Why Mobicip ?
  		try {webDriver.findElement(By.xpath("//h2[contains(text(),'Why Choose Mobicip')]"));
		...
		test.fail("Screen time page - Why Mobicip ? is not present");}
  		...
  		try {TimeUnit.SECONDS.sleep(3);} catch (InterruptedException e) {e.printStackTrace();}	
  		//Customer review
  		try {webDriver.findElement(By.xpath("//p[@class='review_msg']/following::p[text()='Playstore']"));
	...
	public void a5_SocialMediaMoniter()
	{
		...
		try {TimeUnit.SECONDS.sleep(2);} catch (InterruptedException e) {e.printStackTrace();}
  		webDriver.findElement(By.xpath("//a[@class='feature_anchor social_media_monitor ']//span[text()='Social Media Monitor']")).click();
		try {TimeUnit.SECONDS.sleep(2);} catch (InterruptedException e) {e.printStackTrace();}
		//Title
		String tit = webDriver.getTitle();
		...
		//Defination
		a=true;
  		try {webDriver.findElement(By.xpath("//h1[text()='SOCIAL MEDIA MONITOR']"));
  		webDriver.findElement(By.xpath("//span[text()='Parental Monitoring of Social Media']"));
  		webDriver.findElement(By.xpath("//p[contains(text(),'Receive real-time alerts on dangerous interactions and unhealthy behavior.')]"));}
		catch(NoSuchElementException e){a=false;
		...
		try {TimeUnit.SECONDS.sleep(3);} catch (InterruptedException e) {e.printStackTrace();}		
		a=true;
  		try {webDriver.findElement(By.xpath("//h2[text()='Features of Mobicip Social Media Monitor']"));
  		webDriver.findElement(By.xpath("//h3[text()='Social Media Monitor']"));
  		webDriver.findElement(By.xpath("//p[contains(text(),' Facebook and Snapchat for harmful content. Real-time alerts help you to prevent cyberbullying and predatory attacks.')]"));
  		webDriver.findElement(By.xpath("//h3[text()='Alerts']"));
  		webDriver.findElement(By.xpath("//p[contains(text(),'Receive alerts in real time when potentially harmful or inappropriate activity is detectewebDriver.')]"));}
		catch(NoSuchElementException e){a=false;
		...
		try {TimeUnit.SECONDS.sleep(3);} catch (InterruptedException e) {e.printStackTrace();}		
		a=true;
  		try {webDriver.findElement(By.xpath("//h2[text()='Why Monitor Social Media?']"));
  		webDriver.findElement(By.xpath("//h2[text()='Why Monitor Social Media?']/following::div[@class='paragraph_content_container']"));}
  		catch(NoSuchElementException e){a=false;
		test.fail("Social Media Monitor page Importance is not present");}
  		...
  		try {TimeUnit.SECONDS.sleep(3);} catch (InterruptedException e) {e.printStackTrace();}		
  		//Customer review
  		try {webDriver.findElement(By.xpath("//ul[@class='review_container feature swiper_wrapper']"));
  		webDriver.findElement(By.xpath("//p[@class='review_msg']/following::p[text()='Appstore']"));}
  		catch(NoSuchElementException e){a=false;
	...
	public void a6_Appblocker()
	{
		...
		j1.executeScript("window.scrollBy(0,-5500)");
		try {TimeUnit.SECONDS.sleep(2);} catch (InterruptedException e) {e.printStackTrace();}
  		webDriver.findElement(By.xpath("//a[@class='feature_anchor app_blocker ']//span[text()='App Blocker']")).click();
		try {TimeUnit.SECONDS.sleep(2);} catch (InterruptedException e) {e.printStackTrace();}
		//Title
		String tit = webDriver.getTitle();
	    System.out.println(tit);
		...
		//Defination
		a=true;
  		try {webDriver.findElement(By.xpath("//h1[text()='APP BLOCKER']"));
  		webDriver.findElement(By.xpath("//span[text()='Set Healthy Time Limits on Apps']"));
  		webDriver.findElement(By.xpath("//p[contains(text(),'stay focused by blocking and limiting time spent on distracting apps, social media and entertainment.')]"));}
		catch(NoSuchElementException e){a=false;
		...
		try {TimeUnit.SECONDS.sleep(3);} catch (InterruptedException e) {e.printStackTrace();}		
		a=true;
  		try {webDriver.findElement(By.xpath("//h2[text()='Features of Mobicip App Blocker']"));
  		...
  		webDriver.findElement(By.xpath("//p[contains(text(),'Social media and gaming apps distract children from being productive; even leading to screen addiction in some cases.')]"));}
  		catch(NoSuchElementException e){a=false;
		...
		try {TimeUnit.SECONDS.sleep(3);} catch (InterruptedException e) {e.printStackTrace();}		
		a=true;
  		try {webDriver.findElement(By.xpath("//h2[text()='Why Block Apps?']"));
  		webDriver.findElement(By.xpath("//p[@class='paragraph_content' and  contains(text(),'Mobicip shows you all the apps installed on your child')]"));
	...
	public void a7_ActivitySummary(){
		...
		try {TimeUnit.SECONDS.sleep(2);} catch (InterruptedException e) {e.printStackTrace();}
  		webDriver.findElement(By.xpath("//a[@class='feature_anchor activity_summary ']//span[text()='Activity Summary']")).click();
		try {TimeUnit.SECONDS.sleep(2);} catch (InterruptedException e) {e.printStackTrace();}
		//Title
		String tit = webDriver.getTitle();
		...
		//Defination
		a=true;
  		try {webDriver.findElement(By.xpath("//h1[text()='ACTIVITY SUMMARY']"));
  		webDriver.findElement(By.xpath("//span[contains(text(),'Digital Journey')]"));
  		webDriver.findElement(By.xpath("//p[contains(text(),'online activity from an intuitive Parent DashboarwebDriver. Get peace of mind by building healthy digital habits.')]"));}
		catch(NoSuchElementException e){a=false;
		...
		try {TimeUnit.SECONDS.sleep(3);} catch (InterruptedException e) {e.printStackTrace();}		
		a=true;
  		try {webDriver.findElement(By.xpath("//h2[text()='Features of Mobicip Activity Summary']"));
  		webDriver.findElement(By.xpath("//h3[text()='Screen time trends']"));
  		webDriver.findElement(By.xpath("//p[contains(text(),'Keep track of daily screen time consumption and compare against recommended limits. Track usage & time spent on social media, chat and video apps.')]"));
  		webDriver.findElement(By.xpath("//h3[text()='Browsing history']"));
  		webDriver.findElement(By.xpath("//p[contains(text(),'View online browsing history in a rich interface that displays websites visited, videos watched, and more.')]"));
		webDriver.findElement(By.xpath("//h3[text()='Access requests']"));
  		webDriver.findElement(By.xpath("//p[contains(text(),'request for more screen time or access to blocked websites & apps.')]"));
  		webDriver.findElement(By.xpath("//h3[text()='Location history']"));
  		webDriver.findElement(By.xpath("//p[contains(text(),'View locations visited by your children in a given day.')]"));}
		catch(NoSuchElementException e){a=false;
	...
	public void a8_WebsiteBlocker()
	{
		...
		j1.executeScript("window.scrollBy(0,-5680)");
		try {TimeUnit.SECONDS.sleep(2);} catch (InterruptedException e) {e.printStackTrace();}
  		webDriver.findElement(By.xpath("//a[@class='feature_anchor website_blocker ']//span[text()='Website Blocker']")).click();
		try {TimeUnit.SECONDS.sleep(2);} catch (InterruptedException e) {e.printStackTrace();}
		//Title
		String tit = webDriver.getTitle();
		...
		//Defination
		a=true;
  		try {webDriver.findElement(By.xpath("//h1[text()='WEBSITE BLOCKER']"));
  		webDriver.findElement(By.xpath("//span[text()='Website Blocker & Internet Filter: Protect Your Kids Online']"));
  		webDriver.findElement(By.xpath("//p[contains(text(),'Block websites and filter inappropriate content across any browser, YouTube, or other social media.')]"));}
		catch(NoSuchElementException e){a=false;
		...
		try {TimeUnit.SECONDS.sleep(3);} catch (InterruptedException e) {e.printStackTrace();}		
		a=true;
  		try {webDriver.findElement(By.xpath("//h2[text()='Features of Mobicip Website Blocker']"));
  		webDriver.findElement(By.xpath("//h3[text()='Website Filter']"));
  		webDriver.findElement(By.xpath("//p[contains(text(),'Block age-inappropriate websites and 20 web categories.')]"));
  		webDriver.findElement(By.xpath("//h3[text()='Porn Blocker']"));
  		webDriver.findElement(By.xpath("//p[contains(text(),'Nearly 70% of kids inadvertently stumble upon websites displaying porn & violence while searching for something completely innocent online.')]"));
  		j.executeScript("window.scrollBy(0,380)");
		try {TimeUnit.SECONDS.sleep(3);} catch (InterruptedException e) {e.printStackTrace();}
  		webDriver.findElement(By.xpath("//h3[text()='Youtube Filter']"));
  		webDriver.findElement(By.xpath("//p[contains(text(),'Are your kids spending too much time on YouTube? With Mobicip, you can')]"));
  		webDriver.findElement(By.xpath("//h3[text()='Whitelist-Only Mode']"));
  		webDriver.findElement(By.xpath("//p[contains(text(),'Only allow websites that you want your kids to access. Everything else online will be blockewebDriver.')]"));}
		catch(NoSuchElementException e){a=false;
		...
		try {TimeUnit.SECONDS.sleep(3);} catch (InterruptedException e) {e.printStackTrace();}		
		a=true;
  		try {webDriver.findElement(By.xpath("//h2[text()='Why Block Websites or Filter the Internet?']"));
  		webDriver.findElement(By.xpath("//p[@class='paragraph_content' and  contains(text(),'The internet has greatly facilitated a free exchange')]")); }
  		catch(NoSuchElementException e){a=false;
		test.fail("Website Blocker page Importance is not present");}
  		...
  		//Why Mobicip?
  		try {webDriver.findElement(By.xpath("//h2[contains(text(),'Why Choose Mobicip')]"));
  		webDriver.findElement(By.xpath("//strong[contains(text(),'internet filtering software')]/parent::p[@class='paragraph_content']"));}
  		catch(NoSuchElementException e){a=false;
	...
	public void a9_Familylocator()
	{
		...
		j1.executeScript("window.scrollBy(0,-5680)");
		try {TimeUnit.SECONDS.sleep(2);} catch (InterruptedException e) {e.printStackTrace();}
  		webDriver.findElement(By.xpath("//a[@class='feature_anchor family_locator ']//span[text()='Family Locator']")).click();
		try {TimeUnit.SECONDS.sleep(2);} catch (InterruptedException e) {e.printStackTrace();}
		//Title
		String tit = webDriver.getTitle();
		...
		//Defination
		a=true;
  		try {webDriver.findElement(By.xpath("//h1[text()='FAMILY TRACKER']"));
		...
		try {TimeUnit.SECONDS.sleep(3);} catch (InterruptedException e) {e.printStackTrace();}		
		a=true;
  		try {webDriver.findElement(By.xpath("//h2[text()='Features of Mobicip Family Locator']"));
  		webDriver.findElement(By.xpath("//h3[text()='Family Locator']"));
  		webDriver.findElement(By.xpath("//p[contains(text(),'Locate your family anytime using the GPS location tracker and the family map.')]"));
  		webDriver.findElement(By.xpath("//h3[text()='Location Sharing']"));
  		webDriver.findElement(By.xpath("//p[contains(text(),'Share your real-time location to your loved ones to ')]"));
  		j.executeScript("window.scrollBy(0,380)");
		try {TimeUnit.SECONDS.sleep(3);} catch (InterruptedException e) {e.printStackTrace();}
  		webDriver.findElement(By.xpath("//h3[text()='Geofencing']"));
  		webDriver.findElement(By.xpath("//p[contains(text(),'Easily check if your child reached school or a local park. Create')]"));}
		catch(NoSuchElementException e){a=false;
		...
		try {TimeUnit.SECONDS.sleep(3);} catch (InterruptedException e) {e.printStackTrace();}		
		a=true;
  		try {webDriver.findElement(By.xpath("//h2[contains(text(),'Should You Track Your Child')]"));
  		webDriver.findElement(By.xpath("//p[@class='paragraph_content' and  contains(text(),'In the United States alone, an estimated 460,000 children')]")); }
  		catch(NoSuchElementException e){a=false;
		test.fail("Family Locator page Importance is not present");}
  		...
  		//Why Mobicip?
  		try {webDriver.findElement(By.xpath("//h2[contains(text(),'Why Choose Mobicip')]"));
  		webDriver.findElement(By.xpath("//p[contains(text(),'offer at most 2 of the following location tracking features:')]"));}
  		catch(NoSuchElementException e){a=false;
		test.fail("Family Locator page - Why Mobicip ? is not present");}
  		...
  		try {TimeUnit.SECONDS.sleep(3);} catch (InterruptedException e) {e.printStackTrace();}	
  		//Customer review
  		try {webDriver.findElement(By.xpath("//p[text()='Mobicip Dad, Alabama']"));
  		webDriver.findElement(By.xpath("//p[text()='Mobicip Mom, Vermont']"));}
  		catch(NoSuchElementException e){a=false;
	...
	public void b1_Collaboration()
	{
		...
		try {TimeUnit.SECONDS.sleep(2);} catch (InterruptedException e) {e.printStackTrace();}
  		webDriver.findElement(By.xpath("//a[@class='feature_anchor collaboration ']//span[text()='Collaboration']")).click();
		try {TimeUnit.SECONDS.sleep(2);} catch (InterruptedException e) {e.printStackTrace();}
		//Title
		String tit = webDriver.getTitle();
		...
		//Defination
		a=true;
  		try {webDriver.findElement(By.xpath("//h1[text()='COLLABORATION']"));
  		webDriver.findElement(By.xpath("//span[text()='Collaborate with Your Child and Guardian']"));
  		webDriver.findElement(By.xpath("//p[contains(text(),'Invite a co-parent or a guardian to manage your family')]"));}
		catch(NoSuchElementException e){a=false;
		...
		try {TimeUnit.SECONDS.sleep(3);} catch (InterruptedException e) {e.printStackTrace();}		
		a=true;
  		try {webDriver.findElement(By.xpath("//h2[text()='Features of Mobicip Collaboration']"));
  		...
  		webDriver.findElement(By.xpath("//p[contains(text(),'Your children can self-regulate their screen time consumption,')]"));}
		catch(NoSuchElementException e){a=false;
		...
		try {TimeUnit.SECONDS.sleep(3);} catch (InterruptedException e) {e.printStackTrace();}		
		a=true;
  		try {webDriver.findElement(By.xpath("//h2[contains(text(),'Benefits of Collaborating with Children')]"));
  		webDriver.findElement(By.xpath("//p[@class='paragraph_content' and  contains(text(),'Several studies have documented the benefits of parent-child collaboration.')]")); }
  		catch(NoSuchElementException e){a=false;
		test.fail("Collaboration page Importance is not present");}
  		...
  		try {TimeUnit.SECONDS.sleep(3);} catch (InterruptedException e) {e.printStackTrace();}		
  		//Customer review
  		try {webDriver.findElement(By.xpath("//p[contains(text(),'Mobicip Dad')]"));
  		webDriver.findElement(By.xpath("//p[contains(text(),'Mobicip Mom')]"));}
  		catch(NoSuchElementException e){a=false;
	...
	public void b2_ExpertAdvice()
	{
		...
		//Blog -Title
		a=true;
  		try {webDriver.findElement(By.xpath("//a[@title='Blog']"));}
		catch(NoSuchElementException e){a=false;
		...
		//Share button
		a=true;
  		try {webDriver.findElement(By.xpath("//div[@class='share_blog_wrapper']"));}
		catch(NoSuchElementException e){a=false;
