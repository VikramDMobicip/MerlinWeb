...
public class DropALine extends BrowserSetupClass{
    ...
    public void beforeTest() 
    {
		...
		spark = new ExtentSparkReporter("TestReports\\TestDropUsALine\\reportDropUsALine.html");
	...
	public void stillhavequestions() 
	{
		...
		try {webDriver.findElement(By.xpath("//h2[text()='Still Have Questions?']"));}
	...
	public void Dropusaline() {
		...
		boolean a=true;
		try{webDriver.findElement(By.xpath("//span[text()='Drop us a line']")).click();}
		catch(NoSuchElementException e){a=false;
	...
	public void selectquestion() {
		...
		boolean a=true;
		try{webDriver.findElement(By.xpath("//p[text()='Select Question']"));}
		catch(NoSuchElementException e){a=false;
	...
	public void settingupmobicip() {
		...
		boolean a=true;
		try{Select s = new Select(webDriver.findElement(By.xpath("//p[text()='Select Question']/following::select")));
		...
		a=true;
		try{webDriver.findElement(By.xpath("//a[text()='Mobicip parental controls setup - iPhone/iPad']"));}
		catch(NoSuchElementException e){a=false;
		...
		a=true;
		try{webDriver.findElement(By.xpath("//a[text()='New to Mobicip? Get Started!']"));}
		catch(NoSuchElementException e){a=false;
	...
	public void requestinformation() {
		...
		a=true;
		try{webDriver.findElement(By.xpath("//a[text()='Does Mobicip offer a free trial?']"));}
		catch(NoSuchElementException e){a=false;
		...
		a=true;
		try{webDriver.findElement(By.xpath("//a[text()='Will Mobicip monitor Text Messages?']"));}
		catch(NoSuchElementException e){a=false;
	...
	public void featurenotworking() {
		...
		a=true;
		try{webDriver.findElement(By.xpath("//a[text()='Why is Snapchat monitoring not available for iOS devices?']"));}
		catch(NoSuchElementException e){a=false;
...
//		try {TimeUnit.SECONDS.sleep(2);} catch(InterruptedException e) {e.printStackTrace();} 
	...
	public void Other() {
		...
		a=true;
		try{webDriver.findElement(By.xpath("//a[text()='Will Mobicip work in Incognito/Private mode?']"));}
		catch(NoSuchElementException e){a=false;
		...
		a=true;
		try{webDriver.findElement(By.xpath("//a[text()='Why is my customized setting not working on my child device?']"));}
		catch(NoSuchElementException e){a=false;
	...
	public void scroll2() {
		...
		try {TimeUnit.SECONDS.sleep(2);} catch (InterruptedException e) {e.printStackTrace();}
		boolean a=true;
		try{webDriver.findElement(By.xpath("//p[text()='Drop us a message']"));}
		catch(NoSuchElementException e){a=false;
	...
	public void emptyfields(){
		...
		try {TimeUnit.SECONDS.sleep(2);} catch (InterruptedException e) {e.printStackTrace();}
		try{ 
			webDriver.findElement(By.xpath("//p[text()='Drop us a message']/following::span[text()='Required Field'][1]"));
			webDriver.findElement(By.xpath("//p[text()='Drop us a message']/following::span[text()='Required Field'][2]"));
			webDriver.findElement(By.xpath("//p[text()='Drop us a message']/following::span[text()='Required Field'][3]"));
			webDriver.findElement(By.xpath("//p[text()='Drop us a message']/following::span[text()='Required Field'][4]"));} 
		catch(NoSuchElementException e){a=false;
	...
	public void blankspaces(){
		...
		webDriver.findElement(By.xpath("//button[text()='Submit']")).click();
		try {TimeUnit.SECONDS.sleep(2);} catch (InterruptedException e) {e.printStackTrace();}
		try{webDriver.findElement(By.xpath("//p[text()='Drop us a message']/following::span[text()='Only blank space(s) not accepted'][5]"));
			webDriver.findElement(By.xpath("//p[text()='Drop us a message']/following::span[text()='Only blank space(s) not accepted'][1]"));
			webDriver.findElement(By.xpath("//p[text()='Drop us a message']/following::span[text()='Only blank space(s) not accepted'][2]"));
			webDriver.findElement(By.xpath("//p[text()='Drop us a message']/following::span[text()='Only blank space(s) not accepted'][3]"));
			webDriver.findElement(By.xpath("//p[text()='Drop us a message']/following::span[text()='Only blank space(s) not accepted'][4]"));
			webDriver.findElement(By.xpath("//p[text()='Drop us a message']/following::span[text()='Invalid Email: Enter a valid email address']"));
			webDriver.findElement(By.xpath("//p[text()='Drop us a message']/following::span[text()='Only numeric value accepted']"));} 
		catch(NoSuchElementException e){a=false;
	...
	public void name() {
		...
		jse.executeScript("window.scrollBy(0,-350)", "");
		try {TimeUnit.SECONDS.sleep(2);} catch (InterruptedException e) {e.printStackTrace();}
		webDriver.findElement(By.xpath("//input[@id='contact_name']")).clear();
		try {TimeUnit.SECONDS.sleep(2);} catch (InterruptedException e) {e.printStackTrace();}
		webDriver.findElement(By.xpath("//input[@id='contact_name']")).sendKeys("vikram!@#");
		jse.executeScript("window.scrollBy(0,350)", "");
		try {TimeUnit.SECONDS.sleep(2);} catch (InterruptedException e) {e.printStackTrace();}
		webDriver.findElement(By.xpath("//button[text()='Submit']")).click();
		try {TimeUnit.SECONDS.sleep(2);} catch (InterruptedException e) {e.printStackTrace();}
		jse.executeScript("window.scrollBy(0,-350)", "");
		try{TimeUnit.SECONDS.sleep(2);} catch (InterruptedException e) {e.printStackTrace();}
		try{webDriver.findElement(By.xpath("//span[text()='Alphanumeric characters and -_(), only accepted']"))  ;} 
		catch(NoSuchElementException e){a=false;
		...
		webDriver.findElement(By.xpath("//input[@id='contact_name']")).clear();
		try {TimeUnit.SECONDS.sleep(2);} catch (InterruptedException e) {e.printStackTrace();}
		webDriver.findElement(By.xpath("//input[@id='contact_name']")).sendKeys("vikram123");
		jse.executeScript("window.scrollBy(0,350)", "");
		try {TimeUnit.SECONDS.sleep(2);} catch (InterruptedException e) {e.printStackTrace();}
		webDriver.findElement(By.xpath("//button[text()='Submit']")).click();
		try {TimeUnit.SECONDS.sleep(2);} catch (InterruptedException e) {e.printStackTrace();}
		...
		a=true;
		webDriver.findElement(By.xpath("//input[@id='contact_name']")).clear();
		webDriver.findElement(By.xpath("//input[@id='contact_name']")).sendKeys("Vikram-_()");
		jse.executeScript("window.scrollBy(0,350)", "");
		try {TimeUnit.SECONDS.sleep(2);} catch (InterruptedException e) {e.printStackTrace();}
		webDriver.findElement(By.xpath("//button[text()='Submit']")).click();
		try {TimeUnit.SECONDS.sleep(2);} catch (InterruptedException e) {e.printStackTrace();}
	...
	public void email() {
		...
		boolean a=true;
		webDriver.findElement(By.xpath("//input[@id='contact_email']")).clear();
		webDriver.findElement(By.xpath("//input[@id='contact_email']")).sendKeys("vikram+!@#@mobicip.com");
		JavascriptExecutor jse= (JavascriptExecutor) webDriver;
		jse.executeScript("window.scrollBy(0,350)", "");
		try {TimeUnit.SECONDS.sleep(2);} catch (InterruptedException e) {e.printStackTrace();}
		webDriver.findElement(By.xpath("//button[text()='Submit']")).click();
		...
		webDriver.findElement(By.xpath("//input[@id='contact_email']")).clear();
		try {TimeUnit.SECONDS.sleep(2);} catch (InterruptedException e) {e.printStackTrace();}
		webDriver.findElement(By.xpath("//input[@id='contact_email']")).sendKeys("@mobicip.com");
		jse.executeScript("window.scrollBy(0,350)", "");
		try {TimeUnit.SECONDS.sleep(2);} catch (InterruptedException e) {e.printStackTrace();}
		webDriver.findElement(By.xpath("//button[text()='Submit']")).click();
		try {TimeUnit.SECONDS.sleep(2);} catch (InterruptedException e) {e.printStackTrace();}
		...
		a=true;
		webDriver.findElement(By.xpath("//input[@id='contact_email']")).clear();
		webDriver.findElement(By.xpath("//input[@id='contact_email']")).sendKeys("vikram+1@mobicip.com");
		jse1.executeScript("window.scrollBy(0,350)", "");
		try {TimeUnit.SECONDS.sleep(2);} catch (InterruptedException e) {e.printStackTrace();}
		webDriver.findElement(By.xpath("//button[text()='Submit']")).click();
		try {TimeUnit.SECONDS.sleep(2);} catch (InterruptedException e) {e.printStackTrace();}
	...
	public void phone() {
		...
		boolean a=true;
		webDriver.findElement(By.xpath("//input[@id='contact_phone']")).clear();
		try {TimeUnit.SECONDS.sleep(2);} catch (InterruptedException e) {e.printStackTrace();}
		webDriver.findElement(By.xpath("//input[@id='contact_phone']")).sendKeys("abcd");
		JavascriptExecutor jse= (JavascriptExecutor) webDriver;
		jse.executeScript("window.scrollBy(0,350)", "");
		try {TimeUnit.SECONDS.sleep(2);} catch (InterruptedException e) {e.printStackTrace();}
		webDriver.findElement(By.xpath("//button[text()='Submit']")).click();
		...
		jse.executeScript("window.scrollBy(0,-350)", "");
		try {TimeUnit.SECONDS.sleep(2);} catch (InterruptedException e) {e.printStackTrace();}
		try{webDriver.findElement(By.xpath("//span[text()='Only numeric value accepted']"));} 
		catch(NoSuchElementException e){a=false;
		...
		webDriver.findElement(By.xpath("//input[@id='contact_phone']")).clear();
		try {TimeUnit.SECONDS.sleep(2);} catch (InterruptedException e) {e.printStackTrace();}
		webDriver.findElement(By.xpath("//input[@id='contact_phone']")).sendKeys("123!@#");
		jse.executeScript("window.scrollBy(0,350)", "");
		try {TimeUnit.SECONDS.sleep(2);} catch (InterruptedException e) {e.printStackTrace();}
		webDriver.findElement(By.xpath("//button[text()='Submit']")).click();
		try {TimeUnit.SECONDS.sleep(2);} catch (InterruptedException e) {e.printStackTrace();}
		...
		webDriver.findElement(By.xpath("//input[@id='contact_phone']")).clear();
		try {TimeUnit.SECONDS.sleep(2);} catch (InterruptedException e) {e.printStackTrace();}
		webDriver.findElement(By.xpath("//input[@id='contact_phone']")).sendKeys("1234567890");
		jse1.executeScript("window.scrollBy(0,350)", "");
		try {TimeUnit.SECONDS.sleep(2);} catch (InterruptedException e) {e.printStackTrace();}
		webDriver.findElement(By.xpath("//button[text()='Submit']")).click();
		try {TimeUnit.SECONDS.sleep(2);} catch (InterruptedException e) {e.printStackTrace();}
	...
	public void devicename() {
		...
		boolean a=true;
		webDriver.findElement(By.xpath("//input[@id='contact_device']")).clear();
		try {TimeUnit.SECONDS.sleep(2);} catch (InterruptedException e) {e.printStackTrace();}
		webDriver.findElement(By.xpath("//input[@id='contact_device']")).sendKeys("iPhone!@#");
		JavascriptExecutor jse= (JavascriptExecutor) webDriver;
		jse.executeScript("window.scrollBy(0,350)", "");
		try {TimeUnit.SECONDS.sleep(2);} catch (InterruptedException e) {e.printStackTrace();}
		webDriver.findElement(By.xpath("//button[text()='Submit']")).click();
		...
		webDriver.findElement(By.xpath("//input[@id='contact_device']")).clear();
		try {TimeUnit.SECONDS.sleep(2);} catch (InterruptedException e) {e.printStackTrace();}
		webDriver.findElement(By.xpath("//input[@id='contact_device']")).sendKeys("iPhone-13(Pro)");
		jse.executeScript("window.scrollBy(0,350)", "");
		try {TimeUnit.SECONDS.sleep(2);} catch (InterruptedException e) {e.printStackTrace();}
		webDriver.findElement(By.xpath("//button[text()='Submit']")).click();
		try {TimeUnit.SECONDS.sleep(2);} catch (InterruptedException e) {e.printStackTrace();}
	...
	public void OSversion() {
		...
		boolean a=true;
		webDriver.findElement(By.xpath("//input[@id='contact_os']")).clear();
		try {TimeUnit.SECONDS.sleep(2);} catch (InterruptedException e) {e.printStackTrace();}
		webDriver.findElement(By.xpath("//input[@id='contact_os']")).sendKeys("a12!@# ");
		JavascriptExecutor jse= (JavascriptExecutor) webDriver;
		jse.executeScript("window.scrollBy(0,350)", "");
		try {TimeUnit.SECONDS.sleep(2);} catch (InterruptedException e) {e.printStackTrace();}
		webDriver.findElement(By.xpath("//button[text()='Submit']")).click();
		...
		webDriver.findElement(By.xpath("//input[@id='contact_os']")).clear();
		try {TimeUnit.SECONDS.sleep(2);} catch (InterruptedException e) {e.printStackTrace();}
		webDriver.findElement(By.xpath("//input[@id='contact_os']")).sendKeys("15.5");
		jse.executeScript("window.scrollBy(0,350)", "");
		try {TimeUnit.SECONDS.sleep(2);} catch (InterruptedException e) {e.printStackTrace();}
		webDriver.findElement(By.xpath("//button[text()='Submit']")).click();
		try {TimeUnit.SECONDS.sleep(2);} catch (InterruptedException e) {e.printStackTrace();}
	...
	public void childname() {
		...
		boolean a=true;
		webDriver.findElement(By.xpath("//input[@id='contact_child_name']")).clear();
		webDriver.findElement(By.xpath("//input[@id='contact_child_name']")).sendKeys("Marc!@#");
		JavascriptExecutor jse= (JavascriptExecutor) webDriver;
		...
		webDriver.findElement(By.xpath("//input[@id='contact_child_name']")).clear();
		try {TimeUnit.SECONDS.sleep(2);} catch (InterruptedException e) {e.printStackTrace();}
		webDriver.findElement(By.xpath("//input[@id='contact_child_name']")).sendKeys("Marc123");
		jse.executeScript("window.scrollBy(0,200)", "");
		try {TimeUnit.SECONDS.sleep(2);} catch (InterruptedException e) {e.printStackTrace();}
		webDriver.findElement(By.xpath("//button[text()='Submit']")).click();
		try {TimeUnit.SECONDS.sleep(2);} catch (InterruptedException e) {e.printStackTrace();}
		...
		webDriver.findElement(By.xpath("//input[@id='contact_child_name']")).clear();
		try {TimeUnit.SECONDS.sleep(2);} catch (InterruptedException e) {e.printStackTrace();}
		webDriver.findElement(By.xpath("//input[@id='contact_child_name']")).sendKeys("Marc-(12)");
		jse1.executeScript("window.scrollBy(0,200)", "");
		try {TimeUnit.SECONDS.sleep(2);} catch (InterruptedException e) {e.printStackTrace();}
		webDriver.findElement(By.xpath("//button[text()='Submit']")).click();
		try {TimeUnit.SECONDS.sleep(2);} catch (InterruptedException e) {e.printStackTrace();}
	...
	public void message() {
		...
		boolean a=true;
		webDriver.findElement(By.xpath("//textarea[@id='contact_message']")).clear();
		webDriver.findElement(By.xpath("//div[text()='Cancel']")).click();
		try {TimeUnit.SECONDS.sleep(5);} catch (InterruptedException e) {e.printStackTrace();}
		try{webDriver.findElement(By.xpath("//p[@class='backend_message success']"));} 
		catch(NoSuchElementException e){a=false;
		...
		jse.executeScript("window.scrollBy(0,350)", "");
		try {TimeUnit.SECONDS.sleep(2);} catch (InterruptedException e) {e.printStackTrace();}
		webDriver.findElement(By.xpath("//textarea[@id='contact_message']")).sendKeys("QA Mobicip -Automation Testing ,Mobicip (pronounced mo-be-sip) is named after mobile CIPA. CIPA stands for Children's Internet Protection Act, a regulation by the US government that mandates secure internet access when provided by public schools or libraries. In the dark days before smartphones and tablets, the founders had a vision that learning is going to be transformed by ubiquitous always-on mobile technology in the hands of K-12 students. And so Mobicip was born, with a mission to create and foster the safe use of technology for learning and enrichment. A few million downloads, ten years, and petabytes of usage later, we believe the vision has come full circle as the world as we know it, and not just education, has been transformewebDriver. 123!@#$%^&*()_+,ncbjhskamx,cnbdjkasbcndhmxc jksdam,jksamakmsndjla,MSla,jsmxcnbvhfcjksmdncfhusk,mdjsla,zxmcjndkxm ncjcdm,zxnkcjskxamdsjkla,.webDriver.sa;kmxc hjsdiskl,mxcnjhdskmjkmnjkdmnfdjkbfvhjdk333333333333333333333333333333333333333333333333333333333333333");
		try {TimeUnit.SECONDS.sleep(2);} catch (InterruptedException e) {e.printStackTrace();}
		webDriver.findElement(By.xpath("//button[text()='Submit']")).click();
