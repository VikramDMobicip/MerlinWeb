	...
	public void beforeTest() 
	  {
		...
		spark = new ExtentSparkReporter("TestReports\\PreLoginTest\\EnterpriseTest\\enterprisePagesReport.html");
	...
	public void a1_schoolPage() throws InterruptedException
	  {
		...
		new WebDriverWait(webDriver,Duration.ofSeconds(20)).until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//div[@class='enterprise_btn']")));
	...
	public void a2_section1() throws InterruptedException
	  {
		...
		boolean a=true;
		try {webDriver.findElement(By.xpath("//*[text()='Plug & Play Web Filter in the Cloud for Schools']"));}
		catch(NoSuchElementException e){a=false;
		...
		a=true;
		try {webDriver.findElement(By.xpath("//div[@class='enterprise_btn']/child::a[text()='Request Quote']")).click();}
		catch(NoSuchElementException e){a=false;
		...
		a=true;
		try {webDriver.findElement(By.xpath("//div[@class='product_icons_wrapper']/div/figure[1]"));
	...
	public void a3_section2() throws InterruptedException
	  {
		...
		boolean a=true;
		try {webDriver.findElement(By.xpath("//div[@class='main_wrapper']/div/section[3]/div/div/div[1]/div/picture"));}
		catch(NoSuchElementException e){a=false;
		test2.fail("Alpine School icon not present");}
		if(a==true){test2.pass("Alpine School icon present");} 
		
		a=true;
		try {webDriver.findElement(By.xpath("//div[@class='main_wrapper']/div/section[3]/div/div/div[2]/div/picture"));}
		catch(NoSuchElementException e){a=false;
		test2.fail("Lansing Christian school icon not present");}
		if(a==true){test2.pass("Lansing Christian school icon present");}
		
		a=true;
		try {webDriver.findElement(By.xpath("//div[@class='main_wrapper']/div/section[3]/div/div/div[3]/div/picture"));}
		catch(NoSuchElementException e){a=false;
		test2.fail("Los Banos Unified School icon not present");}
		if(a==true){test2.pass("Los Banos Unified School icon present");}
		
		a=true;
		try {webDriver.findElement(By.xpath("//div[@class='main_wrapper']/div/section[3]/div/div/div[4]/div/picture"));}
		catch(NoSuchElementException e){a=false;
		test2.fail("Captapult Learning icon not present");}
		if(a==true){test2.pass("Captapult Learning icon present");}
		
		a=true;
		try {webDriver.findElement(By.xpath("//div[@class='main_wrapper']/div/section[3]/div/div/div[5]/div/picture"));}
		catch(NoSuchElementException e){a=false;
	...
	public void a4_section3() throws InterruptedException
	  {
		...
		boolean a=true;
		try {webDriver.findElement(By.xpath("//*[text()='Plug & Play Web Filter']"));}
		catch(NoSuchElementException e){a=false;
		...
		if(desc1.equals("Mobicip is 100% cloud-basewebDriver. No appliance. No capital equipment. No hardware. No networking expertise requirewebDriver. After all, it is used by millions of parents around the worlwebDriver. Simple, intuitive apps help you deploy web filtering effortlessly on a wide variety of device types. Just install, enable, and manage."))
		{test3.pass("Description - correct");}
		else{test3.fail("Description - not correct");}
		
		a=true;
		try {webDriver.findElement(By.xpath("//*[text()='Web Filter for iPad']"));}
		catch(NoSuchElementException e){a=false;
		...
		String p1 = webDriver.findElement(By.xpath("//div[@class='enterprise_sub_container']/ul[1]/li[1]/span")).getText();
		if(p1.equals("Safe Browser"))
		{test3.pass("point 1 - correct");}
		else{test3.fail("point 1 - wrong");}
		
		String p11 = webDriver.findElement(By.xpath("//div[@class='enterprise_sub_container']/ul[1]/li[2]/span")).getText();
		if(p11.equals("Global Proxy"))
		{test3.pass("point 2 - correct");}
		else{test3.fail("point 2 - wrong");}
		
		String p12 = webDriver.findElement(By.xpath("//div[@class='enterprise_sub_container']/ul[1]/li[3]/span")).getText();
		if(p12.equals("Enforced VPN"))
		{test3.pass("point 3 - correct");}
		else{test3.fail("point 3 - wrong");}
		
		String p13 = webDriver.findElement(By.xpath("//div[@class='enterprise_sub_container']/ul[1]/li[4]/span")).getText();
		...
		String p2 = webDriver.findElement(By.xpath("//div[@class='enterprise_sub_container']/ul[2]/li[1]/span")).getText();
		if(p2.equals("Deployment server"))
		{test3.pass("point 1 - correct");}
		else{test3.fail("point 1 - wrong");}
		
		String p21 = webDriver.findElement(By.xpath("//div[@class='enterprise_sub_container']/ul[2]/li[2]/span")).getText();
		if(p21.equals("MDM Integration"))
		{test3.pass("point 2 - correct");}
		else{test3.fail("point 2 - wrong");}
		
		String p22 = webDriver.findElement(By.xpath("//div[@class='enterprise_sub_container']/ul[2]/li[3]/span")).getText();
		if(p22.equals("Single Sign-on"))
		{test3.pass("point 3 - correct");}
		else{test3.fail("point 3 - wrong");}
		
		String p23 = webDriver.findElement(By.xpath("//div[@class='enterprise_sub_container']/ul[2]/li[4]/span")).getText();
		...
		String p3 = webDriver.findElement(By.xpath("//div[@class='enterprise_sub_container']/ul[3]/li[1]/span")).getText();
		if(p3.equals("Intuitive web console"))
		{test3.pass("point 1 - correct");}
		else{test3.fail("point 1 - wrong");}
		
		String p31 = webDriver.findElement(By.xpath("//div[@class='enterprise_sub_container']/ul[3]/li[2]/span")).getText();
		if(p31.equals("Admin app on iOS & Android"))
		{test3.pass("point 2 - correct");}
		else{test3.fail("point 2 - wrong");}
		
		String p32 = webDriver.findElement(By.xpath("//div[@class='enterprise_sub_container']/ul[3]/li[3]/span")).getText();
		if(p32.equals("Override requests"))
		{test3.pass("point 3 - correct");}
		else{test3.fail("point 3 - wrong");}
		
		String p33 = webDriver.findElement(By.xpath("//div[@class='enterprise_sub_container']/ul[3]/li[4]/span")).getText();
		...
		a=true;
		try {webDriver.findElement(By.xpath("//*[text()='Web Filter for Chromebook']"));}
		catch(NoSuchElementException e){a=false;
		...
		a=true;
		try {webDriver.findElement(By.xpath("//*[text()='Web Filter for Windows']"));}
		catch(NoSuchElementException e){a=false;
		...
		a=true;
		try {webDriver.findElement(By.xpath("//*[text()='Web Filter for Mac']"));}
		catch(NoSuchElementException e){a=false;
		...
		a=true;
		try {webDriver.findElement(By.xpath("//*[text()='Web Filter for Android, Kindle, Nook']"));}
		catch(NoSuchElementException e){a=false;
		...
		a=true;
		try {webDriver.findElement(By.xpath("//*[text()='Easy Reporting & Admin']"));}
		catch(NoSuchElementException e){a=false;
	...
	public void a5_section4() throws InterruptedException
	  {
		...
		boolean a=true;
		try {webDriver.findElement(By.xpath("//*[text()='Safe. Secure. Reliable']"));}
		catch(NoSuchElementException e){a=false;
		test4.fail("Section title is not correct");}
		if(a==true){test4.pass("Section title is correct");}   	
	 	
		a=true;
		try {webDriver.findElement(By.xpath("//ul[@class='enterprise_feature_wrapper'][1]/li[1]/span[1]"));}
		catch(NoSuchElementException e){a=false;
		...
		a=true;
		try {webDriver.findElement(By.xpath("//ul[@class='enterprise_feature_wrapper'][1]/li[2]/span[1]"));}
		catch(NoSuchElementException e){a=false;
		...
		a=true;
		try {webDriver.findElement(By.xpath("//ul[@class='enterprise_feature_wrapper'][1]/li[3]/span[1]"));}
		catch(NoSuchElementException e){a=false;
		...
		if(li3.equals("Customize settings & review browsing history reports from web dashboarwebDriver."))
		{test4.pass("3.Title - correct");}
		else{test4.fail("3.Title - not correct");}
		
		a=true;
		try {webDriver.findElement(By.xpath("//ul[@class='enterprise_feature_wrapper'][1]/li[4]/span[1]"));}
		catch(NoSuchElementException e){a=false;
		...
		a=true;
		try {webDriver.findElement(By.xpath("//div[@class='main_wrapper']/div/section[5]/div/div/div[1]/div/div/div[2]/ul/li/span[1]"));}
		catch(NoSuchElementException e){a=false;
		test4.fail("5.Icon - not correct");}
		if(a==true){test4.pass("5.Icon - correct");}
		
		String li5 = webDriver.findElement(By.xpath("//div[@class='main_wrapper']/div/section[5]/div/div/div[1]/div/div/div[2]/ul/li/p")).getText();
		...
		a=true;
		try {webDriver.findElement(By.xpath("//div[@class='swiper_bullets_container']/div/span[1]")).click();}
		catch(NoSuchElementException e){a=false;
	...
	public void a6_section5() throws InterruptedException
	  {
		...
		boolean a=true;
		try {webDriver.findElement(By.xpath("//*[text()='What They Say']"));}
		catch(NoSuchElementException e){a=false;
		test5.fail("Section title is not correct");}
		if(a==true){test5.pass("Section title is correct");}   	
	 	
		a=true;
		try {webDriver.findElement(By.xpath("//div[@class='review_wrapper']/div[1]/span"));}
		catch(NoSuchElementException e){a=false;
		test5.fail("Left Quotation icon - not displayed");}
		if(a==true){test5.pass("Left Quotation icon - displayed");}
		
		a=true;
		try {webDriver.findElement(By.xpath("//div[@class='review_wrapper']/div[3]/span"));}
		catch(NoSuchElementException e){a=false;
		...
		a=true;
		try {webDriver.findElement(By.xpath("//div[@class='review_wrapper']/div[2]/ul/li[1]/div/div[1]/picture"));}
		catch(NoSuchElementException e){a=false;
		test5.fail("Image - not displayed");}
		if(a==true){test5.pass("Image - displayed");}
		
		a=true;
		try {webDriver.findElement(By.xpath("//*[text()='Walt Bringolf']"));}
		catch(NoSuchElementException e){a=false;
		test5.fail("Name is not correct");}
		if(a==true){test5.pass("Name is correct");}
		
		a=true;
		try {webDriver.findElement(By.xpath("//p[text()='Middle School Chairman,'and text()='Providence Christian School']"));}
		catch(NoSuchElementException e){a=false;
		...
		a=true;
		try {webDriver.findElement(By.xpath("//div[@class='review_wrapper']/div[2]/ul/li[2]/div/div[1]/picture"));}
		catch(NoSuchElementException e){a=false;
		test5.fail("Image - not displayed");}
		if(a==true){test5.pass("Image - displayed");}
		
		a=true;
		try {webDriver.findElement(By.xpath("//*[text()='Susan Wells']"));}
		catch(NoSuchElementException e){a=false;
		test5.fail("Name is not correct");}
		if(a==true){test5.pass("Name is correct");}
		
		a=true;
		try {webDriver.findElement(By.xpath("//p[text()='Principal,'and text()='WG Pearson School, NC']"));}
		catch(NoSuchElementException e){a=false;
		test5.fail("School name is not correct");}
		if(a==true){test5.pass("School name is correct");}
		...
		a=true;
		try {webDriver.findElement(By.xpath("//div[@class='review_wrapper']/div[2]/ul/li[3]/div/div[1]/picture"));}
		catch(NoSuchElementException e){a=false;
		test5.fail("Image - not displayed");}
		if(a==true){test5.pass("Image - displayed");}
		
		a=true;
		try {webDriver.findElement(By.xpath("//*[text()='Jason Salas']"));}
		catch(NoSuchElementException e){a=false;
		test5.fail("Name is not correct");}
		if(a==true){test5.pass("Name is correct");}
		
		a=true;
		try {webDriver.findElement(By.xpath("//p[text()='Charleston Catholic School']"));}
		catch(NoSuchElementException e){a=false;
		test5.fail("School name is not correct");}
		if(a==true){test5.pass("School name is correct");}
	  }		
	...
	public void a7_section6() throws InterruptedException
	  {
		...
		boolean a=true;
		try {webDriver.findElement(By.xpath("//div[@class='main_wrapper']/div/section[7]/div/div/div[1]/div/picture"));}
		catch(NoSuchElementException e){a=false;
		test6.fail("The Huffington Post icon not present");}
		if(a==true){test6.pass("The Huffington Post icon present");} 
		
		a=true;
		try {webDriver.findElement(By.xpath("//div[@class='main_wrapper']/div/section[7]/div/div/div[2]/div/picture"));}
		catch(NoSuchElementException e){a=false;
		test6.fail("PC icon not present");}
		if(a==true){test6.pass("PC icon present");}
		
		a=true;
		try {webDriver.findElement(By.xpath("//div[@class='main_wrapper']/div/section[7]/div/div/div[3]/div/picture"));}
		catch(NoSuchElementException e){a=false;
		test6.fail("The Newyork Times icon not present");}
		if(a==true){test6.pass("The Newyork Times icon present");}
		
		a=true;
		try {webDriver.findElement(By.xpath("//div[@class='main_wrapper']/div/section[7]/div/div/div[4]/div/picture"));}
		catch(NoSuchElementException e){a=false;
		test6.fail("Today icon not present");}
		if(a==true){test6.pass("Today icon present");}
		
		a=true;
		try {webDriver.findElement(By.xpath("//div[@class='main_wrapper']/div/section[7]/div/div/div[5]/div/picture"));}
		catch(NoSuchElementException e){a=false;
	...
	public void b1_businessPage() throws InterruptedException
	  {
		...
		try {webDriver.findElement(By.xpath("/html/body/div[1]/div/footer/div[2]/div/div[1]/div[1]/div[2]/ul/li[5]/a")).click();}
		catch(NoSuchElementException e){a=false;
	...
	public void b2_section1() throws InterruptedException
	  {
		...
		boolean a=true;
		try {webDriver.findElement(By.xpath("//*[text()='Reliable Web Filtering in the Cloud for Business']"));}
		catch(NoSuchElementException e){a=false;
	...
	public void b4_section3() throws InterruptedException
	  {
		...
		String desc1 = webDriver.findElement(By.xpath("//div[@class='enterprise_wrapper']/div[1]/p")).getText();
		if(desc1.equals("Mobicip is 100% cloud-basewebDriver. No appliance. No capital equipment. No hardware. No networking expertise requirewebDriver. After all, the Family edition is used by millions of parents around the worlwebDriver. Simple, intuitive apps help you deploy web filtering effortlessly on a wide variety of device types. Just install, enable, and it is good to go."))
