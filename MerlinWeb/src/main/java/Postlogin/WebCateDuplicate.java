...
public class WebCateDuplicate extends BrowserSetup{
	...
	public void beforeTest() 
	{
		...
		spark = new ExtentSparkReporter("TestReports\\PostloginTest\\TestCategoryDuplicate\\reportContentCategoryDupli.html");
...
//		webDriver.findElement(By.xpath("//p[text()='DuplicateAuto']")).click();    
	...
	public void a2_ContentWebCategory()
	{
		...
		try{webDriver.findElement(By.xpath("//a[@class='logo']"));
			webDriver.findElement(By.xpath("//p[text()='Content']"));
	...
	public void a3_ContentWebCategory()
	{
		...
		try{webDriver.findElement(By.xpath("//span[text()='Web Categories']/following-sibling::span[@class='icon_right_arrow']"));
			webDriver.findElement(By.xpath("//span[text()='Allowed Websites']/following-sibling::span[@class='icon_right_arrow']"));
			webDriver.findElement(By.xpath("//span[text()='Blocked Websites']/following-sibling::span[@class='icon_right_arrow']"));
			webDriver.findElement(By.xpath("//span[text()='Networks']/following-sibling::span[@class='icon_right_arrow']"));
			webDriver.findElement(By.xpath("//span[text()='Keywords and Phrases']/following-sibling::span[@class='icon_right_arrow']"));
	...
	public void a4_ContentWebCategory()
	{
		...
		try{webDriver.findElement(By.xpath("//p[text()='You cannot change web settings as Jerry is in Monitor only mode.']"));}
		catch(NoSuchElementException e) {a=false;
	...
	public void a5_ContentWebCategory()
	{
		...
		JavascriptExecutor j = (JavascriptExecutor)webDriver;
		j.executeScript("window.scrollBy(0,300)");
		webDriver.findElement(By.xpath("//span[text()='Web Categories']")).click();
		try {TimeUnit.SECONDS.sleep(3);} catch (InterruptedException e) {e.printStackTrace();}
		String tit=webDriver.getTitle();
		...
		try {TimeUnit.SECONDS.sleep(2);} catch (InterruptedException e) {e.printStackTrace();}
		try{webDriver.findElement(By.xpath("//a[@class='logo']"));
			webDriver.findElement(By.xpath("//p[text()='Web Categories']"));
	...
	public void a6_ContentWebCategory()
	{
		...
		boolean a=true;
  		try{webDriver.findElement(By.xpath("//p[text()=\"Mobicip by default blocks certain web categories based on child's age.\"]"));
  			webDriver.findElement(By.xpath("//p[text()='Settings will not apply to Mobicip preset schedules.']"));
  			webDriver.findElement(By.xpath("//p[@class='blocked_label']"));}
  		catch(NoSuchElementException e) {a=false;
	...
	public void a7_ContentWebCategory()
	{
		...
		boolean a= true;
		try {TimeUnit.SECONDS.sleep(2);} catch (InterruptedException e) {e.printStackTrace();}
		try{webDriver.findElement(By.xpath("//span[text()='Ads and Marketing']"));
			webDriver.findElement(By.xpath("//span[text()='Ads and Marketing']/following-sibling::div[@class='toggle_switch_container']"));}
		catch(NoSuchElementException e) {a=false;
		...
		a= true;
		try{webDriver.findElement(By.xpath("//span[text()='Alcohol and Addiction']"));
			webDriver.findElement(By.xpath("//span[text()='Alcohol and Addiction']/following-sibling::div[@class='toggle_switch_container']"));}
		catch(NoSuchElementException e) {a=false;
		...
		//Dating
		a= true;
		try{webDriver.findElement(By.xpath("//span[text()='Dating']"));
			webDriver.findElement(By.xpath("//span[text()='Dating']/following-sibling::div[@class='toggle_switch_container']"));}
		catch(NoSuchElementException e) {a=false;
		...
		try{webDriver.findElement(By.xpath("//span[text()='Entertainment']"));
			webDriver.findElement(By.xpath("//span[text()='Entertainment']/following-sibling::div[@class='toggle_switch_container']"));}
		catch(NoSuchElementException e) {a=false;
		...
		//Gambling
		a= true;
		try{webDriver.findElement(By.xpath("//span[text()='Gambling']"));
			webDriver.findElement(By.xpath("//span[text()='Gambling']/following-sibling::div[@class='toggle_switch_container']"));}
		catch(NoSuchElementException e) {a=false;
		...
		try{webDriver.findElement(By.xpath("//span[text()='Games']"));
			webDriver.findElement(By.xpath("//span[text()='Games']/following-sibling::div[@class='toggle_switch_container']"));}
		catch(NoSuchElementException e) {a=false;
		test.fail("Web categories  - Games category is not present");}
		if(a==true){test.pass("Web categories  - Games category are present");}
		//Government and Society
		a= true;
		try{webDriver.findElement(By.xpath("//span[text()='Government and Society']"));
			webDriver.findElement(By.xpath("//span[text()='Government and Society']/following-sibling::div[@class='toggle_switch_container']"));}
		catch(NoSuchElementException e) {a=false;
		...
		//Health
		a= true;
		try{webDriver.findElement(By.xpath("//span[text()='Health']"));
			webDriver.findElement(By.xpath("//span[text()='Health']/following-sibling::div[@class='toggle_switch_container']"));}
		catch(NoSuchElementException e) {a=false;
		test.fail("Web categories  - Health category is not present");}
		if(a==true){test.pass("Web categories  - Health category are present");}
		//Lifestyle
		a= true;
		try{webDriver.findElement(By.xpath("//span[text()='Lifestyle']"));
			webDriver.findElement(By.xpath("//span[text()='Lifestyle']/following-sibling::div[@class='toggle_switch_container']"));}
		catch(NoSuchElementException e) {a=false;
		...
		//Mature and Adult
		a= true;
		try{webDriver.findElement(By.xpath("//span[text()='Mature and Adult']"));
			webDriver.findElement(By.xpath("//span[text()='Mature and Adult']/following-sibling::div[@class='toggle_switch_container']"));}
		catch(NoSuchElementException e) {a=false;
		...
		//News
		a= true;
		try{webDriver.findElement(By.xpath("//span[text()='News']"));
			webDriver.findElement(By.xpath("//span[text()='News']/following-sibling::div[@class='toggle_switch_container']"));}
		catch(NoSuchElementException e) {a=false;
		test.fail("Web categories  - News category is not present");}
		if(a==true){test.pass("Web categories  - News category are present");}
		//Proxies
		a= true;
		try{webDriver.findElement(By.xpath("//span[text()='Proxies']"));
			webDriver.findElement(By.xpath("//span[text()='Proxies']/following-sibling::div[@class='toggle_switch_container']"));}
		catch(NoSuchElementException e) {a=false;
		test.fail("Web categories  - Proxies category is not present");}
		if(a==true){test.pass("Web categories  - Proxies category are present");}
		//Shopping
		a= true;
		try{webDriver.findElement(By.xpath("//span[text()='Shopping']"));
			webDriver.findElement(By.xpath("//span[text()='Shopping']/following-sibling::div[@class='toggle_switch_container']"));}
		catch(NoSuchElementException e) {a=false;
		...
		//Social
		a= true;
		try{webDriver.findElement(By.xpath("//span[text()='Social']"));
			webDriver.findElement(By.xpath("//span[text()='Social']/following-sibling::div[@class='toggle_switch_container']"));}
		catch(NoSuchElementException e) {a=false;
		test.fail("Web categories  - Social category is not present");}
		if(a==true){test.pass("Web categories  - Social category are present");}
		//Sports
		a= true;
		try{webDriver.findElement(By.xpath("//span[text()='Sports']"));
			webDriver.findElement(By.xpath("//span[text()='Sports']/following-sibling::div[@class='toggle_switch_container']"));}
		catch(NoSuchElementException e) {a=false;
		...
		//Utilities
		a= true;
		try{webDriver.findElement(By.xpath("//span[text()='Utilities']"));
			webDriver.findElement(By.xpath("//span[text()='Utilities']/following-sibling::div[@class='toggle_switch_container']"));}
		catch(NoSuchElementException e) {a=false;
		...
		a= true;
		try{webDriver.findElement(By.xpath("//span[text()='Weapons and Violence']"));
			webDriver.findElement(By.xpath("//span[text()='Weapons and Violence']/following-sibling::div[@class='toggle_switch_container']"));}
		catch(NoSuchElementException e) {a=false;
		...
		//YouTube
		a= true;
		try{webDriver.findElement(By.xpath("//span[text()='YouTube']"));
			webDriver.findElement(By.xpath("//span[text()='YouTube']/following-sibling::div[@class='toggle_switch_container']"));}
		catch(NoSuchElementException e) {a=false;
	...
	public void a8_ContentWebCategory()
	{
		...
		//Ads and Marketing
		boolean a= true;
		try{webDriver.findElement(By.xpath("//span[text()='Ads and Marketing']/following::label[1]")).click();}
		catch(NoSuchElementException e) {a=false;
		...
		//Alcohol and Addiction
		a= true;
		try{webDriver.findElement(By.xpath("//span[text()='Alcohol and Addiction']/following::label[1]")).click();}
		catch(NoSuchElementException e) {a=false;
		...
		//Dating
		a= true;
		try{webDriver.findElement(By.xpath("//span[text()='Dating']/following::label[1]")).click();}
		catch(NoSuchElementException e) {a=false;
		...
		//Entertainment
		a= true;
		try{webDriver.findElement(By.xpath("//span[text()='Entertainment']/following::label[1]")).click();}
		catch(NoSuchElementException e) {a=false;
		...
		//Gambling
		a= true;
		try{webDriver.findElement(By.xpath("//span[text()='Gambling']/following::label[1]")).click();}
		catch(NoSuchElementException e) {a=false;
		...
		//Games
		a= true;
		try{webDriver.findElement(By.xpath("//span[text()='Games']/following::label[1]")).click();}
		catch(NoSuchElementException e) {a=false;
		...
		//Government and Society
		a= true;
		try{webDriver.findElement(By.xpath("//span[text()='Government and Society']/following::label[1]")).click();}
		catch(NoSuchElementException e) {a=false;
		...
		//Health
		a= true;
		try{webDriver.findElement(By.xpath("//span[text()='Health']/following::label[1]")).click();}
		catch(NoSuchElementException e) {a=false;
		...
		//Lifestyle
		a= true;
		try{webDriver.findElement(By.xpath("//span[text()='Lifestyle']/following::label[1]")).click();}
		catch(NoSuchElementException e) {a=false;
		...
		//Mature and Adult
		a= true;
		try{webDriver.findElement(By.xpath("//span[text()='Mature and Adult']/following::label[1]")).click();}
		catch(NoSuchElementException e) {a=false;
		...
		//News
		a= true;
		try{webDriver.findElement(By.xpath("//span[text()='News']/following::label[1]")).click();}
		catch(NoSuchElementException e) {a=false;
		...
		//Proxies
		a= true;
		try{webDriver.findElement(By.xpath("//span[text()='Proxies']/following::label[1]")).click();}
		catch(NoSuchElementException e) {a=false;
		...
		//Shopping
		a= true;
		try{webDriver.findElement(By.xpath("//span[text()='Shopping']/following::label[1]")).click();}
		catch(NoSuchElementException e) {a=false;
		...
		//Social
		a= true;
		try{webDriver.findElement(By.xpath("//span[text()='Social']/following::label[1]")).click();}
		catch(NoSuchElementException e) {a=false;
		...
		//Sports
		a= true;
		try{webDriver.findElement(By.xpath("//span[text()='Sports']/following::label[1]")).click();}
		catch(NoSuchElementException e) {a=false;
		...
		//Utilities
		a= true;
		try{webDriver.findElement(By.xpath("//span[text()='Utilities']/following::label[1]")).click();}
		catch(NoSuchElementException e) {a=false;
		...
		//Weapons and Violence
		a= true;
		try{webDriver.findElement(By.xpath("//span[text()='Weapons and Violence']/following::label[1]")).click();}
		catch(NoSuchElementException e) {a=false;
		...
		//YouTube
		a= true;
		try{webDriver.findElement(By.xpath("//span[text()='YouTube']/following::label[1]")).click();}
		catch(NoSuchElementException e) {a=false;
	...
	public void a9_ContentWebCategory()
	{
		...
		boolean a= true;
		try{webDriver.findElement(By.xpath("//span[text()='Ads and Marketing']/following::input[@id='category_toggle_500' and @checked]"));
			webDriver.findElement(By.xpath("//span[text()='Alcohol and Addiction']/following::input[@id='category_toggle_501' and not(@checked)]"));}
		catch(NoSuchElementException e) {a=false;
		test.fail("Situation is not expected");}
		if(a==true){test.pass("Situation is expected");}
		try {TimeUnit.SECONDS.sleep(2);} catch (InterruptedException e) {e.printStackTrace();}
		
		webDriver.findElement(By.xpath("//span[text()='Ads and Marketing']/following::label[1]")).click();
		try {TimeUnit.SECONDS.sleep(2);} catch (InterruptedException e) {e.printStackTrace();}
		webDriver.findElement(By.xpath("//span[text()='Alcohol and Addiction']/following::label[1]")).click();
		try {TimeUnit.SECONDS.sleep(2);} catch (InterruptedException e) {e.printStackTrace();}
		webDriver.navigate().refresh();   
		// it is must to refresh once we clicked on toggle button, then only it will get changed in xpath
		try {TimeUnit.SECONDS.sleep(4);} catch (InterruptedException e) {e.printStackTrace();}
		try{webDriver.findElement(By.xpath("//span[text()='Ads and Marketing']/following::input[@id='category_toggle_500' and not(@checked)]"));
			webDriver.findElement(By.xpath("//span[text()='Alcohol and Addiction']/following::input[@id='category_toggle_501' and @checked]"));}
		catch(NoSuchElementException e) {a=false;
	...
	public void b1_ContentWebDuplicate()
	{
		...
		try{webDriver.findElement(By.xpath("//a[@class='logo']"));
			...
			webDriver.findElement(By.xpath("//span[@id='headerBack']"));
			webDriver.findElement(By.xpath("//div[@title='DuplicateAuto']/div[@class='profile_image_container']"));
			webDriver.findElement(By.xpath("//a[starts-with(@class,'icon_notification')]"));
			webDriver.findElement(By.xpath("//div[@class='user_profile_container']"));}
		catch(NoSuchElementException e) {a=false;
	...
	public void b2_ContentWebDuplicate()
	{
		...
		boolean a= true;
		try{webDriver.findElement(By.xpath("//p[text()='Select Child User']"));
		...
		//specific options
		a= true;
		try{webDriver.findElement(By.xpath("//input[@value='Allowed Websites']/following-sibling::label[1]"));
			webDriver.findElement(By.xpath("//input[@value='Blocked Websites']/following-sibling::label[1]"));
			webDriver.findElement(By.xpath("//input[@value='Keywords and Phrases']/following-sibling::label[1]"));
			webDriver.findElement(By.xpath("//input[@value='Networks']/following-sibling::label[1]"));
			webDriver.findElement(By.xpath("//input[@value='Web Categories']/following-sibling::label[1]"));
			webDriver.findElement(By.xpath("//p[text()='Allowed Websites']"));
			webDriver.findElement(By.xpath("//p[text()='Keywords and Phrases']"));
			webDriver.findElement(By.xpath("//p[text()='Networks']"));
			webDriver.findElement(By.xpath("//p[text()='Web Categories']"));
			webDriver.findElement(By.xpath("//p[text()='Blocked Websites']"));}
		catch(NoSuchElementException e) {a=false;
		...
		//All options
		a= true;
		try{webDriver.findElement(By.xpath("//input[@id='check_all']/following-sibling::label[1]"));
	...
	public void b5_ContentWebDuplicate()
	{
		...
		webDriver.findElement(By.xpath("//input[@value='Allowed Websites']/following-sibling::label[1]")).click();
		try {TimeUnit.SECONDS.sleep(2);} catch (InterruptedException e) {e.printStackTrace();}
		try{webDriver.findElement(By.xpath("//button[text()='Save']")).click();}
		catch(NoSuchElementException e) {a=false;
		...
		try {TimeUnit.SECONDS.sleep(2);} catch (InterruptedException e) {e.printStackTrace();}
		webDriver.findElement(By.xpath("//p[text()='MAM Automation']")).click();
		try {TimeUnit.SECONDS.sleep(2);} catch (InterruptedException e) {e.printStackTrace();}
		JavascriptExecutor j = (JavascriptExecutor)webDriver;
		j.executeScript("window.scrollBy(0,500)");
		try {TimeUnit.SECONDS.sleep(2);} catch (InterruptedException e) {e.printStackTrace();}
		webDriver.findElement(By.xpath("//span[text()='Allowed Websites']")).click();
		try {TimeUnit.SECONDS.sleep(4);} catch (InterruptedException e) {e.printStackTrace();}
		a=true;
		try{webDriver.findElement(By.xpath("//span[text()='icc.in']"));}
		catch(NoSuchElementException e) {a=false;
		...
		webDriver.findElement(By.xpath("//span[text()='icc.in']/preceding::label[1]")). click();	
		try {TimeUnit.SECONDS.sleep(2);} catch (InterruptedException e) {e.printStackTrace();}
	...
	public void b6_ContentWebDuplicate()
	{
		...
		j1.executeScript("window.scrollBy(0,500)");
		try {TimeUnit.SECONDS.sleep(2);} catch (InterruptedException e) {e.printStackTrace();}
		webDriver.findElement(By.xpath("//input[@value='Blocked Websites']/following-sibling::label[1]")).click();
		try {TimeUnit.SECONDS.sleep(2);} catch (InterruptedException e) {e.printStackTrace();}
		try{webDriver.findElement(By.xpath("//button[text()='Save']")).click();}
		catch(NoSuchElementException e) {a=false;
		...
		j.executeScript("window.scrollBy(0,500)");
		try {TimeUnit.SECONDS.sleep(2);} catch (InterruptedException e) {e.printStackTrace();}
		webDriver.findElement(By.xpath("//span[text()='Blocked Websites']")).click();
		a=true;
		try {TimeUnit.SECONDS.sleep(4);} catch (InterruptedException e) {e.printStackTrace();}
		try{webDriver.findElement(By.xpath("//span[text()='cricbuzz.com']"));}
		catch(NoSuchElementException e) {a=false;
		...
		webDriver.findElement(By.xpath("//span[text()='cricbuzz.com']/preceding::label[1]")).click();	
		try {TimeUnit.SECONDS.sleep(2);} catch (InterruptedException e) {e.printStackTrace();}
  		webDriver.findElement(By.xpath("//span[text()='Delete selected']")).click();
		try {TimeUnit.SECONDS.sleep(2);} catch (InterruptedException e) {e.printStackTrace();}
		webDriver.findElement(By.xpath("//button[text()='Yes']")).click();
	...
	public void b7_ContentWebDuplicate()
	{
		...
		j1.executeScript("window.scrollBy(0,500)");
		try {TimeUnit.SECONDS.sleep(3);} catch (InterruptedException e) {e.printStackTrace();}
		webDriver.findElement(By.xpath("//input[@value='Web Categories']/following-sibling::label[1]")).click();
		try {TimeUnit.SECONDS.sleep(2);} catch (InterruptedException e) {e.printStackTrace();}
		try{webDriver.findElement(By.xpath("//button[text()='Save']")).click();}
		catch(NoSuchElementException e) {a=false;
		...
		try{webDriver.findElement(By.xpath("//span[text()='Ads and Marketing']/following::input[@id='category_toggle_500' and not(@checked)]"));
			webDriver.findElement(By.xpath("//span[text()='Alcohol and Addiction']/following::input[@id='category_toggle_501' and not(@checked)]"));
			webDriver.findElement(By.xpath("//span[text()='Entertainment']/following::input[@id='category_toggle_509' and @checked]"));
			webDriver.findElement(By.xpath("//span[text()='Dating']/following::input[@id='category_toggle_506' and not(@checked)]"));}
		catch(NoSuchElementException e) {a=false;
		...
		webDriver.findElement(By.xpath("//span[text()='Ads and Marketing']/following::label[1]")).click();	
		webDriver.findElement(By.xpath("//span[text()='Alcohol and Addiction']/following::label[1]")).click();	
		webDriver.findElement(By.xpath("//span[text()='Dating']/following::label[1]")).click();	
		try {TimeUnit.SECONDS.sleep(4);} catch (InterruptedException e) {e.printStackTrace();}
		webDriver.findElement(By.xpath("//span[@id='headerBack']")).click();
		try {TimeUnit.SECONDS.sleep(3);} catch (InterruptedException e) {e.printStackTrace();}
		JavascriptExecutor j8 = (JavascriptExecutor)webDriver;
	...
	public void b8_ContentWebDuplicate()
	{
		...
		j1.executeScript("window.scrollBy(0,500)");
		try {TimeUnit.SECONDS.sleep(3);} catch (InterruptedException e) {e.printStackTrace();}
		webDriver.findElement(By.xpath("//input[@value='Networks']/following-sibling::label[1]")).click();
		try {TimeUnit.SECONDS.sleep(2);} catch (InterruptedException e) {e.printStackTrace();}
		try{webDriver.findElement(By.xpath("//button[text()='Save']")).click();}
		catch(NoSuchElementException e) {a=false;
		...
		a=true;
		try{webDriver.findElement(By.xpath("//div[text()='1.2.3.4']"));
			webDriver.findElement(By.xpath("//div[text()='1.1.1.1' and text()='/' and text()='255.0.0.0']"));}
		catch(NoSuchElementException e) {a=false;
		...
		webDriver.findElement(By.xpath("//div[text()='1.2.3.4']/preceding::label[1]")).click();	
		try {TimeUnit.SECONDS.sleep(2);} catch (InterruptedException e) {e.printStackTrace();}
  		webDriver.findElement(By.xpath("//span[text()='Delete selected']")).click();
		try {TimeUnit.SECONDS.sleep(2);} catch (InterruptedException e) {e.printStackTrace();}
		webDriver.findElement(By.xpath("//div[text()='1.1.1.1' and text()='/' and text()='255.0.0.0']/preceding::label[1]")).click();	
		try {TimeUnit.SECONDS.sleep(2);} catch (InterruptedException e) {e.printStackTrace();}
  		webDriver.findElement(By.xpath("//span[text()='Delete selected']")).click();
		try {TimeUnit.SECONDS.sleep(2);} catch (InterruptedException e) {e.printStackTrace();}
		webDriver.findElement(By.xpath("//span[@id='headerBack']")).click();
	...
	public void b9_ContentWebDuplicate()
	{
		...
		j1.executeScript("window.scrollBy(0,500)");
		try {TimeUnit.SECONDS.sleep(3);} catch (InterruptedException e) {e.printStackTrace();}
		webDriver.findElement(By.xpath("//input[@value='Keywords and Phrases']/following-sibling::label[1]")).click();
		try {TimeUnit.SECONDS.sleep(2);} catch (InterruptedException e) {e.printStackTrace();}
		try{webDriver.findElement(By.xpath("//button[text()='Save']")).click();}
		catch(NoSuchElementException e) {a=false;
		...
		try {TimeUnit.SECONDS.sleep(4);} catch (InterruptedException e) {e.printStackTrace();}
		a=true;
		try{webDriver.findElement(By.xpath("//span[text()='box office']"));}
		catch(NoSuchElementException e) {a=false;
		...
		try {TimeUnit.SECONDS.sleep(3);} catch (InterruptedException e) {e.printStackTrace();}
		webDriver.findElement(By.xpath("//span[text()='box office']/preceding::label[1]")).click();	
		try {TimeUnit.SECONDS.sleep(2);} catch (InterruptedException e) {e.printStackTrace();}
  		webDriver.findElement(By.xpath("//span[text()='Delete selected']")).click();
		try {TimeUnit.SECONDS.sleep(2);} catch (InterruptedException e) {e.printStackTrace();}
		webDriver.findElement(By.xpath("//button[text()='Yes']")).click();
...
//				try {TimeUnit.SECONDS.sleep(3);} catch (InterruptedException e) {e.printStackTrace();}
		...
		try {TimeUnit.SECONDS.sleep(3);} catch (InterruptedException e) {e.printStackTrace();}
		webDriver.findElement(By.xpath("//input[@name='check_all']/following-sibling::label[1]")).click();
		try {TimeUnit.SECONDS.sleep(2);} catch (InterruptedException e) {e.printStackTrace();}
		try{webDriver.findElement(By.xpath("//button[text()='Save']")).click();}
		catch(NoSuchElementException e) {a=false;
	...
	public void c1_ContentWebDuplicate()
	{
		...
		try {TimeUnit.SECONDS.sleep(4);} catch (InterruptedException e) {e.printStackTrace();}
		a=true;
		try{webDriver.findElement(By.xpath("//span[text()='No websites added']"));}
		catch(NoSuchElementException e) {a=false;
		...
		try{webDriver.findElement(By.xpath("//span[text()='Ads and Marketing']/following::input[@id='category_toggle_500' and @checked]"));
			webDriver.findElement(By.xpath("//span[text()='Alcohol and Addiction']/following::input[@id='category_toggle_501' and @checked]"));
			webDriver.findElement(By.xpath("//span[text()='Entertainment']/following::input[@id='category_toggle_509' and @checked]"));
			webDriver.findElement(By.xpath("//span[text()='Dating']/following::input[@id='category_toggle_506' and @checked]"));}
		catch(NoSuchElementException e) {a=false;
		...
		webDriver.findElement(By.xpath("//span[text()='IP Address Range']")).click();
		a=true;
		try{webDriver.findElement(By.xpath("//span[text()='No network added']/following::span[text()='No network added']"));
			webDriver.findElement(By.xpath("//span[text()='No network added']/preceding::span[text()='No network added']"));}
		catch(NoSuchElementException e) {a=false;
