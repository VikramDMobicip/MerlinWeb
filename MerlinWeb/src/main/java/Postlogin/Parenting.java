...
public class Parenting extends BrowserSetup {
    ...
    public void beforeTest() 
    {
		...
		spark = new ExtentSparkReporter("TestReports\\PostloginTest\\TestParenting\\reportParenting.html");
	...
	public void a3_Blogs() {
  		...
  		boolean a = true;
  		try{webDriver.findElement(By.xpath("//p[text()='From our Blog']"));
	...
	public void a4_DangerousApps() {
  		...
  		boolean a = true;
  		try{webDriver.findElement(By.xpath("//p[text()='Dangerous apps']"));} 
		catch(NoSuchElementException e){a=false;
		...
		a = true;
  		try{webDriver.findElement(By.xpath("//p[text()='Yubo']"));
		...
		a = true;
  		try{webDriver.findElement(By.xpath("//p[text()='Finsta']"));
		...
		a = true;
  		try{webDriver.findElement(By.xpath("//p[text()='Unsafe apps']"));
	...
	public void a5_AppsforEducation() {
  		...
  		boolean a = true;
  		try{webDriver.findElement(By.xpath("//p[text()='Apps for education']"));} 
		catch(NoSuchElementException e){a=false;
		...
		a = true;
  		try{webDriver.findElement(By.xpath("//p[text()='Email services']"));
		...
		a = true;
  		try{webDriver.findElement(By.xpath("//p[text()='Educational apps']"));
	...
	public void a6_Trendingamongstteens(){
  		...
  		boolean a = true;
  		try{webDriver.findElement(By.xpath("//p[text()='Trending amongst teens']"));}
		catch(NoSuchElementException e){a=false;
		...
		a = true;
  		try{webDriver.findElement(By.xpath("//p[text()='Poparazzi']"));
		...
		a = true;
  		try{webDriver.findElement(By.xpath("//p[text()='Marcopolo']"));
	...
	public void a7_LearnfromourExperts(){
		...
		try {TimeUnit.SECONDS.sleep(2);} catch (InterruptedException e) {e.printStackTrace();}
  		try{webDriver.findElement(By.xpath("//p[text()='Learn from our Experts']"));}
		catch(NoSuchElementException e){a=false;
		test7.fail("Learn from our Experts is not present");}
		if(a==true) {test7.pass("Learn from our Experts is present");}

		a = true;
  		try{webDriver.findElement(By.xpath("//p[text()='Diana Graber']"));
		...
		a = true;
  		try{webDriver.findElement(By.xpath("//p[text()='Cyberwise Chats']"));
	...
	public void a8_Help(){
     	...
     	boolean a = true;
     	try{webDriver.findElement(By.xpath("//a[text()='Looking for help on a specific topic?']"));
	...
	public void a9_Help(){
     	...
     	boolean a = true;
		try {TimeUnit.SECONDS.sleep(2);} catch (InterruptedException e) {e.printStackTrace();}
     	try{webDriver.findElement(By.xpath("//p[text()='Follow our Social Media Pages']"));
  		webDriver.findElement(By.xpath("//a[@href='/blog']"));} 
		catch(NoSuchElementException e){a=false;
		...
		a = true;
     	try{webDriver.findElement(By.xpath("//a[@class='facebook']"));
		...
		a = true;
     	try{webDriver.findElement(By.xpath("//a[@class='twitter']"));
		...
		a = true;
     	try{webDriver.findElement(By.xpath("//a[@class='linkedin']"));
		...
		a = true;
     	try{webDriver.findElement(By.xpath("//a[@class='instagram']"));
  		webDriver.findElement(By.xpath("//a[@href='https://www.instagram.com/mobicip_family']"));} 
		catch(NoSuchElementException e){a=false;
