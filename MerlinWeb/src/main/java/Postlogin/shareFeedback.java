...
public class shareFeedback extends BrowserSetup{
    ...
    public void beforeTest() 
    {
		...
		spark = new ExtentSparkReporter("TestReports\\PostloginTest\\TestShareFeedback\\reportShareFeedback.html");
	...
	public void a2_AboutMobicipHeader() {
		...
		a=true;
		try{webDriver.findElement(By.xpath("//a[starts-with(@class,'icon_notification ')]"));} 
		catch(NoSuchElementException e){a=false;
	...
	public void a3_ShareFeedbackInfotext(){
  		...
  		boolean a = true;
  		try{webDriver.findElement(By.xpath("//p[text()='On a scale of 0 to 10, how likely are you to recommend Mobicip to a friend?']"));} 
		catch(NoSuchElementException e){a=false;
	...
	public void a4_ShareFeedbackPageComponents(){
  		...
  		boolean a = true;
  		try{webDriver.findElement(By.xpath("//span[text()='Not Likely']"));} 
		catch(NoSuchElementException e){a=false;
		test4.fail("Not Likely text is not found");}
		if(a==true) {test4.pass("Not Likely text is present");}
		
		a = true;
  		try{webDriver.findElement(By.xpath("//span[text()='Likely']"));} 
		catch(NoSuchElementException e){a=false;
	...
	public void a5_Feedback9and10(){
  		...
  		boolean a = true;
  		try{webDriver.findElement(By.xpath("//span[@class='input-range__label-container' and text()='10']"));} 
		catch(NoSuchElementException e){a=false;
		...
		if(a==true) {test5.pass("Rating 10 is shown by default");}
  		...
  		a = true;
  		try{webDriver.findElement(By.xpath("//span[@class='input-range__label-container' and text()='9']"));} 
		catch(NoSuchElementException e){a=false;
		...
		//checking happy emoji shown while 9 is selected
  		a = true;
  		try{webDriver.findElement(By.xpath("//div[@class='input-range__slider happy']"));} 
		catch(NoSuchElementException e){a=false;
		...
		a = true;
  		try{webDriver.findElement(By.xpath("//div[@class='feedback_user_input']"));} 
		catch(NoSuchElementException e){a=false;
		...
		webDriver.findElement(By.xpath("//button[text()='Submit']")).click();
  		try {TimeUnit.SECONDS.sleep(4);} catch (InterruptedException e) {e.printStackTrace();}
		a = true;
  		try{webDriver.findElement(By.xpath("//p[text()='Thank you for sharing your valuable feedback!']"));
	...
	public void a6_Feedback7and8(){
  		...
  		boolean a = true;
  		try{webDriver.findElement(By.xpath("//span[@class='input-range__label-container' and text()='8']"));} 
		catch(NoSuchElementException e){a=false;
		...
		//checking speechless emoji shown while 8 is selected
  		a = true;
  		try{webDriver.findElement(By.xpath("//div[@class='input-range__slider speechless']"));} 
		catch(NoSuchElementException e){a=false;
		...
		//Slider function
  		...
  		a = true;
  		try{webDriver.findElement(By.xpath("//span[@class='input-range__label-container' and text()='7']"));} 
		catch(NoSuchElementException e){a=false;
...
//  	}
	...
	public void a7_Feedback7and8(){
  		...
  		boolean a = true;
  		try{webDriver.findElement(By.xpath("//span[@class='input-range__label-container' and text()='6']"));} 
		catch(NoSuchElementException e){a=false;
		...
		//checking Sad emoji shown while 6 is selected
  		a = true;
  		try{webDriver.findElement(By.xpath("//div[@class='input-range__slider sad']"));} 
		catch(NoSuchElementException e){a=false;
		...
		goToShareFeedbackPage();
  		...
  		a = true;
  		try{webDriver.findElement(By.xpath("//span[@class='input-range__label-container' and text()='5']"));} 
		catch(NoSuchElementException e){a=false;
		...
		goToShareFeedbackPage();
  		...
  		a = true;
  		try{webDriver.findElement(By.xpath("//span[@class='input-range__label-container' and text()='4']"));} 
		catch(NoSuchElementException e){a=false;
		...
		goToShareFeedbackPage();
  		...
  		a = true;
  		try{webDriver.findElement(By.xpath("//span[@class='input-range__label-container' and text()='3']"));} 
		catch(NoSuchElementException e){a=false;
		...
		goToShareFeedbackPage();
  		...
  		a = true;
  		try{webDriver.findElement(By.xpath("//span[@class='input-range__label-container' and text()='2']"));} 
		catch(NoSuchElementException e){a=false;
		...
		goToShareFeedbackPage();
  		...
  		a = true;
  		try{webDriver.findElement(By.xpath("//span[@class='input-range__label-container' and text()='1']"));} 
		catch(NoSuchElementException e){a=false;
		...
		j5.executeScript("window.scrollBy(0,1000)"); 
  		try {TimeUnit.SECONDS.sleep(2);} catch (InterruptedException e) {e.printStackTrace();}webDriver.findElement(By.xpath("//button[text()='Submit']")).click();
  		try {TimeUnit.SECONDS.sleep(4);} catch (InterruptedException e) {e.printStackTrace();}
		a = true;
  		try{webDriver.findElement(By.xpath("//p[text()='Thank you for sharing your valuable feedback!']"));
  		webDriver.findElement(By.xpath("//img[@alt='Feedback thanks']"));} 
		...
		goToShareFeedbackPage();
  		...
  		a = true;
  		try{webDriver.findElement(By.xpath("//span[@class='input-range__label-container' and text()='0']"));} 
		catch(NoSuchElementException e){a=false;
	...
	public void b1_ReasonFeedbackResponded(){
  	...
  	public void b2_Feedback(){
	  	...
	  	JavascriptExecutor j = (JavascriptExecutor)webDriver;
		j.executeScript("window.scrollBy(0,1000)");
		webDriver.findElement(By.xpath("//textarea[@name='feedback_text']")).sendKeys("QWERTYUIOPASDFGHJKLZXCVBN#$@@!%QWERTYUIOPASDFGHJKLZXCVBN");
  		try {TimeUnit.SECONDS.sleep(2);} catch (InterruptedException e) {e.printStackTrace();}
	  	webDriver.findElement(By.xpath("//button[text()='Submit']")).click();
	  	try {TimeUnit.SECONDS.sleep(4);} catch (InterruptedException e) {e.printStackTrace();}
	  	boolean a=true;
		...
		webDriver.findElement(By.xpath("//textarea[@name='feedback_text']")).sendKeys("QWERTYUIOPASDFGHJKLZXCVBNQWERTYUIOPASDFGHJKLZXCVBNQWERTYUIOPASDFGHJKLZXCVBNQWERTYUIOPASDFGHJKLZXCVBNQWERTYUIOPASDFGHJKLZXCVBNQWERTYUIOPASDFGHJKLZXCVBNQWERTYUIOPASDFGHJKLZXCVBNQWERTYUIOPASDFGHJKLZXCVBNQWERTYUIOPASDFGHJKLZXCVBNQWERTYUIOPASDFGHJKLZXCVBNQWERT");
  		try {TimeUnit.SECONDS.sleep(2);} catch (InterruptedException e) {e.printStackTrace();}
	  	webDriver.findElement(By.xpath("//button[text()='Submit']")).click();
	  	try {TimeUnit.SECONDS.sleep(4);} catch (InterruptedException e) {e.printStackTrace();}
	  	a=true;
	  	try{webDriver.findElement(By.xpath("//span[text()='More than 250 characters not accepted']"));} 
		catch(NoSuchElementException e){a=false;
		...
		if(a==true) {test12.pass("Unable to submit With More then 250 characters and Alert message shown while More then 250 characters are added");}	
	  	...
	  	webDriver.findElement(By.xpath("//textarea[@name='feedback_text']")).sendKeys("QWERTYUIOPASDFGHJKLZXCVBNQWERTYUIOPASDFGHJKLZXCVBNQWERTYUIOPASDFGHJKLZXCVBNqwertyuiop123456");
  		try {TimeUnit.SECONDS.sleep(2);} catch (InterruptedException e) {e.printStackTrace();}
	  	webDriver.findElement(By.xpath("//button[text()='Submit']")).click();
	  	try {TimeUnit.SECONDS.sleep(4);} catch (InterruptedException e) {e.printStackTrace();}
	    a=true;
		...
		j1.executeScript("window.scrollBy(0,1000)");
  		try {TimeUnit.SECONDS.sleep(2);} catch (InterruptedException e) {e.printStackTrace();}
	  	webDriver.findElement(By.xpath("//textarea[@name='feedback_text']")).sendKeys("QWERTYUIOPASDFGHJKLZXCVBNQWERTYUIOPASDFGHJKLZXCVBNQWERTYUIOPASDFGHJKLZXCVBNQWERTYUIOPASDFGHJKLZXCVBNQWERTYUIOPASDFGHJKLZXCVBNQWERTYUIOPASDFGHJKLZXCVBNQWERTYUIOPASDFGHJKLZXCVBNQWERTYUIOPASDFGHJKLZXCVBNQWERTYUIOPASDFGHJKLZXCVBNQWERTYUIOPASDFGHJKLZXCVBN");
  		try {TimeUnit.SECONDS.sleep(2);} catch (InterruptedException e) {e.printStackTrace();}
	  	webDriver.findElement(By.xpath("//button[text()='Submit']")).click();
	  	try {TimeUnit.SECONDS.sleep(4);} catch (InterruptedException e) {e.printStackTrace();}
	    a=true;
