...
public class shareFeedback extends BrowserSetup {
	 ...
	 * "TestReports\\PostloginTest\\TestShareFeedback\\reportShareFeedback.html");
	 * extentreport.attachReporter(spark); }
	 */
	// Checking for the title of home page and About mobicip page
	@Test(priority = 1)
	public void a1_homepage() {
		ExtentTest test = extentreport.createTest("Share Feedback page",
				"Checking the title of the Share Feedback page ");
		extentTest.set(test);
		...
		new WebDriverWait(webDriver, Duration.ofSeconds(20))
				.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//span[text()='Share Feedback']")));

		webDriver.findElement(By.xpath("//span[text()='Share Feedback']")).click();
		try {
		...
		if (tit.equals("Share Feedback | Mobicip")) {
			...
			test.fail("Share Feedback - title isn't correct ");
		}
	}
	...
	public void a2_AboutMobicipHeader() {
		...
		a = true;
		try {
			webDriver.findElement(By.xpath("//p[text()='Share Feedback']"));
		} catch (NoSuchElementException e) {
			a = false;
	...
	public void a3_ShareFeedbackInfotext() {
		...
		try {
			webDriver.findElement(By.xpath(
					"//p[text()='On a scale of 0 to 10, how likely are you to recommend Mobicip to a friend?']"));
		} catch (NoSuchElementException e) {
			a = false;
			test3.fail("Mobicip Info text is not found");
		}
		if (a == true) {
			test3.pass("Mobicip Info text is present");
		}
	}
	...
	public void a4_ShareFeedbackPageComponents() {
		...
		boolean a = true;
		try {
			webDriver.findElement(By.xpath("//span[text()='Not Likely']"));
		} catch (NoSuchElementException e) {
			a = false;
			test4.fail("Not Likely text is not found");
		}
		if (a == true) {
			test4.pass("Not Likely text is present");
		}

		a = true;
		try {
			webDriver.findElement(By.xpath("//span[text()='Likely']"));
		} catch (NoSuchElementException e) {
			a = false;
			test4.fail("Likely text is not found");
		}
		if (a == true) {
			test4.pass("Likely text is present");
		}
		try {
			TimeUnit.SECONDS.sleep(3);
		} catch (InterruptedException e) {
		...
		a = true;
		try {
			webDriver.findElement(By.xpath("//div[@class='input-range']"));
		} catch (NoSuchElementException e) {
			a = false;
			test4.fail("Rating bar  is not found");
		}
		if (a == true) {
			test4.pass("Rating bar is present");
		}

		a = true;
		try {
			webDriver.findElement(By.xpath("//div[@class='slider_label']"));
		} catch (NoSuchElementException e) {
			a = false;
			test4.fail("Rating bar value text is not found");
		}
		if (a == true) {
			test4.pass("Rating bar value is present");
		}
		...
		if (a == true) {
			test4.pass("Submit button is present");
		}
	}
	...
	public void a5_Feedback9and10() {
		ExtentTest test5 = extentreport.createTest("Share Feedback - 9 & 10 ",
				"Verify able to submit rating with 9 and 10. Warm Smile emoji is shown and No feedback form shown");
		extentTest.set(test5);
		// Checking value 10 shown by default
		boolean a = true;
		try {
			webDriver.findElement(By.xpath("//span[@class='input-range__label-container' and text()='10']"));
		} catch (NoSuchElementException e) {
			a = false;
			test5.fail("Rating 10 is not shown by default");
		}
		if (a == true) {
			test5.pass("Rating 10 is shown by default");
		}

		// Slider function
		WebElement slider = webDriver.findElement(By.xpath("//span[@class='input-range__slider-container']"));
		...
		a = true;
		try {
			webDriver.findElement(By.xpath("//span[@class='input-range__label-container' and text()='9']"));
		} catch (NoSuchElementException e) {
			a = false;
			test5.fail("Rating 9 is not selected after a step of left slide");
		}
		if (a == true) {
			test5.pass("Rating 9 is  selected after a step of left slide");
		}

		// checking happy emoji shown while 9 is selected
		a = true;
		try {
			webDriver.findElement(By.xpath("//div[@class='input-range__slider happy']"));
		} catch (NoSuchElementException e) {
			a = false;
			test5.fail("Happy emoji is not shown while 9 is selected");
		}
		if (a == true) {
			test5.pass("Happy emoji is shown while 9 is selected");
		}

		// No feedback,reason needed
		a = true;
		try {
			webDriver.findElement(By.xpath("//div[@class='feedback_user_input']"));
		} catch (NoSuchElementException e) {
			a = false;
			test5.pass("Feedback and Reason options are not shown properly while 9 is selected");
		}
		if (a == true) {
			test5.fail("Feedback and Reason options are shown - improper");
		}
		...
		a = true;
		try {
			webDriver.findElement(By.xpath("//p[text()='Thank you for sharing your valuable feedback!']"));
			webDriver.findElement(By.xpath("//img[@alt='Feedback thanks']"));
		} catch (NoSuchElementException e) {
			a = false;
			test5.fail("Rating with 9 is not successfully submitted");
		}
		if (a == true) {
			test5.pass("Rating with 9 is successfully submitted");
		}

		// Existing issue - while submit with 9 shows an info section of app rating ,
		// Which is not expected in web
		a = true;
		try {
			webDriver.findElement(By.xpath("//div[@class='app_rating']"));
		} catch (NoSuchElementException e) {
			a = false;
			test5.fail("App rating section is not shown.");
		}
		if (a == true) {
			test5.pass("App rating section is shown");
		}

		// Checking with rating 10
		goToShareFeedbackPage();
		// Slider function
		WebElement slider1 = webDriver.findElement(By.xpath("//span[@class='input-range__slider-container']"));
		...
		if (a == true) {
			test5.pass("Rating 10 is  selected after some step of right slide");
		}
		...
		if (a == true) {
			test5.pass("Happy emoji is shown while 10 is selected");
		}
		...
		if (a == true) {
			test5.fail("Feedback and Reason options are shown while 10 is selected - improper");
		}
		...
		if (a == true) {
			test5.pass("Rating with 10 is successfully submitted");
		}
		...
		try {
			...
			a = false;
			test5.fail("App rating section is shown");
		}
		if (a == true) {
			test5.pass("App rating section is not shown as expected");
		}
	}
	...
	public void a6_Feedback7and8() {
		ExtentTest test6 = extentreport.createTest("Share Feedback - 7 & 8",
				"Verify able to submit rating with 7 and 8. Neutral face emoji is shown and  feedback form shown");
		...
		boolean a = true;
		try {
			webDriver.findElement(By.xpath("//span[@class='input-range__label-container' and text()='8']"));
		} catch (NoSuchElementException e) {
			a = false;
			test6.fail("Rating 8 is not selected after a step of left slide");
		}
		if (a == true) {
			test6.pass("Rating 8 is  selected after a step of left slide");
		}

		// checking speechless emoji shown while 8 is selected
		a = true;
		try {
			webDriver.findElement(By.xpath("//div[@class='input-range__slider speechless']"));
		} catch (NoSuchElementException e) {
			a = false;
			test6.fail("speechless emoji is not shown while 8 is selected");
		}
		if (a == true) {
			test6.pass("speechless emoji is shown while 8 is selected");
		}
		...
		if (a == true) {
			test6.pass("Feedback and Reason options are shown properly while 8 is selected");
		}
		...
		if (a == true) {
			test6.pass("Rating with 8 is successfully submitted");
		}

		// Existing issue - while submit with 8 shows an info section of app rating ,
		// Which is not expected in web
		a = true;
		try {
			webDriver.findElement(By.xpath("//div[@class='app_rating']"));
		...
		if (a == true) {
			test6.fail("App rating section is shown. The issue is not fixed for value 8");
		}
		...
		a = true;
		try {
			webDriver.findElement(By.xpath("//span[@class='input-range__label-container' and text()='7']"));
		} catch (NoSuchElementException e) {
			a = false;
			test6.fail("Rating 7 is not selected after some step of right slide");
		}
		if (a == true) {
			test6.pass("Rating 7 is  selected after some step of right slide");
		}
		...
		if (a == true) {
			test6.pass("speechless emoji is shown while 7 is selected");
		}
		...
		if (a == true) {
			test6.pass("Feedback and Reason options are shown properly while 7 is selected");
		}
		...
		if (a == true) {
			test6.pass("Rating with 7 is successfully submitted");
		}
		...
		if (a == true) {
			test6.fail("App rating section is shown. Reproduced with 7");
		}
	}

//  public int app_rating_issue() {
//  	boolean a = true;
//		try{webDriver.findElement(By.xpath("//div[@class='app_rating']"));} 
...
//  	}
	...
	public void a7_Feedback7and8() {
		ExtentTest test7 = extentreport.createTest("Share Feedback - 0 to 6",
				"Verify able to submit rating with  0 to 6. Frown emoji is shown and  feedback form shown");
		...
		boolean a = true;
		try {
			webDriver.findElement(By.xpath("//span[@class='input-range__label-container' and text()='6']"));
		} catch (NoSuchElementException e) {
			a = false;
			test7.fail("Rating 6 is not selected after a step of left slide");
		}
		if (a == true) {
			test7.pass("Rating 6 is  selected after a step of left slide");
		}

		// checking Sad emoji shown while 6 is selected
		a = true;
		try {
			webDriver.findElement(By.xpath("//div[@class='input-range__slider sad']"));
		} catch (NoSuchElementException e) {
			a = false;
			test7.fail("sad emoji is not shown while 6 is selected");
		}
		if (a == true) {
			test7.pass("sad emoji is shown while 6 is selected");
		}
		...
		if (a == true) {
			test7.pass("Feedback and Reason options are shown properly while 6 is selected");
		}
		...
		if (a == true) {
			test7.pass("Rating with 6 is successfully submitted");
		}
		...
		if (a == true) {
			test7.fail("App rating section is shown. Reproduced with 6");
		}
		...
		a = true;
		try {
			webDriver.findElement(By.xpath("//span[@class='input-range__label-container' and text()='5']"));
		} catch (NoSuchElementException e) {
			a = false;
			test7.fail("Rating 5 is not selected after a step of left slide");
		}
		if (a == true) {
			test7.pass("Rating 5 is  selected after a step of left slide");
		}
		...
		if (a == true) {
			test7.pass("sad emoji is shown while 5 is selected");
		}
		...
		if (a == true) {
			test7.pass("Feedback and Reason options are shown properly while 5 is selected");
		}
		...
		if (a == true) {
			test7.pass("Rating with 5 is successfully submitted");
		}
		...
		if (a == true) {
			test7.fail("App rating section is shown. Reproduced with 5");
		}

		// Checking for value 4
		goToShareFeedbackPage();
		// Slider function
		WebElement slider2 = webDriver.findElement(By.xpath("//span[@class='input-range__slider-container']"));
		...
		a = true;
		try {
			webDriver.findElement(By.xpath("//span[@class='input-range__label-container' and text()='4']"));
		} catch (NoSuchElementException e) {
			a = false;
			test7.fail("Rating 4 is not selected after a step of left slide");
		}
		if (a == true) {
			test7.pass("Rating 4 is  selected after a step of left slide");
		}
		...
		if (a == true) {
			test7.pass("sad emoji is shown while 4 is selected");
		}
		...
		if (a == true) {
			test7.pass("Feedback and Reason options are shown properly while 4 is selected");
		}
		...
		if (a == true) {
			test7.pass("Rating with 4 is successfully submitted");
		}
		...
		if (a == true) {
			test7.fail("App rating section is shown. Reproduced with 4");
		}

		// Checking with rating 3
		goToShareFeedbackPage();
		// Slider function
		WebElement slider3 = webDriver.findElement(By.xpath("//span[@class='input-range__slider-container']"));
		...
		a = true;
		try {
			webDriver.findElement(By.xpath("//span[@class='input-range__label-container' and text()='3']"));
		} catch (NoSuchElementException e) {
			a = false;
			test7.fail("Rating 3 is not selected after a step of left slide");
		}
		if (a == true) {
			test7.pass("Rating 3 is  selected after a step of left slide");
		}
		...
		if (a == true) {
			test7.pass("sad emoji is shown while 3 is selected");
		}
		...
		if (a == true) {
			test7.pass("Feedback and Reason options are shown properly while 3 is selected");
		}
		...
		if (a == true) {
			test7.pass("Rating with 3 is successfully submitted");
		}
		...
		if (a == true) {
			test7.fail("App rating section is shown. Reproduced with 3");
		}

		// Checking for value 2
		goToShareFeedbackPage();
		// Slider function
		WebElement slider4 = webDriver.findElement(By.xpath("//span[@class='input-range__slider-container']"));
		...
		a = true;
		try {
			webDriver.findElement(By.xpath("//span[@class='input-range__label-container' and text()='2']"));
		} catch (NoSuchElementException e) {
			a = false;
			test7.fail("Rating 2 is not selected after a step of left slide");
		}
		if (a == true) {
			test7.pass("Rating 2 is  selected after a step of left slide");
		}
		...
		if (a == true) {
			test7.pass("sad emoji is shown while 2 is selected");
		}
		...
		if (a == true) {
			test7.pass("Feedback and Reason options are shown properly while 2 is selected");
		}
		...
		if (a == true) {
			test7.pass("Rating with 2 is successfully submitted");
		}
		...
		if (a == true) {
			test7.fail("App rating section is shown. Reproduced with 2");
		}
		...
		// Slider function
		WebElement slider5 = webDriver.findElement(By.xpath("//span[@class='input-range__slider-container']"));
		...
		a = true;
		try {
			webDriver.findElement(By.xpath("//span[@class='input-range__label-container' and text()='1']"));
		} catch (NoSuchElementException e) {
			a = false;
			test7.fail("Rating 1 is not selected after a step of left slide");
		}
		if (a == true) {
			test7.pass("Rating 1 is  selected after a step of left slide");
		}
		...
		if (a == true) {
			test7.pass("sad emoji is shown while 1 is selected");
		}
		...
		if (a == true) {
			test7.pass("Feedback and Reason options are shown properly while 1 is selected");
		}
		...
		if (a == true) {
			test7.pass("Rating with 1 is successfully submitted");
		}
		...
		if (a == true) {
			test7.fail("App rating section is shown. Reproduced with 1");
		}
		...
		// Slider function
		WebElement slider6 = webDriver.findElement(By.xpath("//span[@class='input-range__slider-container']"));
		...
		a = true;
		try {
			webDriver.findElement(By.xpath("//span[@class='input-range__label-container' and text()='0']"));
		} catch (NoSuchElementException e) {
			a = false;
			test7.fail("Rating 0 is not selected after a step of left slide");
		}
		if (a == true) {
			test7.pass("Rating 0 is  selected after a step of left slide");
		}
		...
		if (a == true) {
			test7.pass("sad emoji is shown while 0 is selected");
		}
		...
		if (a == true) {
			test7.pass("Feedback and Reason options are shown properly while 0 is selected");
		}
		...
		if (a == true) {
			test7.pass("Rating with 0 is successfully submitted");
		}
		...
		if (a == true) {
			test7.fail("App rating section is shown. Reproduced with 0");
		}
	}

	@Test(priority = 8)
	public void a8_ReasonFeedbackResponded() {
		ExtentTest test8 = extentreport.createTest("Tell us Why , Feedback - responded ",
				"Verify able to submit with select Tell us why and add Feedback");
		...
		webDriver.findElement(By.xpath("//label[@for='support_button']")).click();
		try {
			TimeUnit.SECONDS.sleep(1);
		} catch (InterruptedException e) {
			e.printStackTrace();
		}
		webDriver.findElement(By.xpath("//label[@for='setup_button']")).click();
		try {
			TimeUnit.SECONDS.sleep(1);
		} catch (InterruptedException e) {
			e.printStackTrace();
		}
		webDriver.findElement(By.xpath("//label[@for='security_button']")).click();
		try {
			TimeUnit.SECONDS.sleep(1);
		} catch (InterruptedException e) {
			e.printStackTrace();
		}
		webDriver.findElement(By.xpath("//label[@for='features_button']")).click();
		try {
			TimeUnit.SECONDS.sleep(1);
		} catch (InterruptedException e) {
			e.printStackTrace();
		}
		webDriver.findElement(By.xpath("//textarea[@name='feedback_text']")).sendKeys("QA Automation");
		try {
			TimeUnit.SECONDS.sleep(2);
		} catch (InterruptedException e) {
			e.printStackTrace();
		...
		if (a == true) {
			test8.pass("Able to submit with select Tell us why and add Feedback");
		}
	}
	...
	public void a9_ReasonFeedbackNotResponded() {
		ExtentTest test9 = extentreport.createTest("Tell us Why , Feedback - Not responded ",
				"Verify able to submit without select Tell us why and add Feedback");
		...
		if (a == true) {
			test9.pass("Able to submit without select Tell us why and add Feedback");
		}
	}
	...
	public void b0_ReasonOnlyResponded() {
		ExtentTest test10 = extentreport.createTest("Tell us Why - responded, Feedback -  Not responded",
				"Verify able to submit with select Tell us why and  without add Feedback");
		...
		if (a == true) {
			test10.pass("Able to submit with select Tell us why and  without add Feedback");
		}
	}
	...
	public void b1_ReasonFeedbackResponded() {
		ExtentTest test11 = extentreport.createTest("Tell us Why - Not responded , Feedback -  responded",
				"Verify able to submit without select Tell us why and  with add Feedback");
		...
		webDriver.findElement(By.xpath("//textarea[@name='feedback_text']")).sendKeys("Automation QA");
		try {
			TimeUnit.SECONDS.sleep(2);
		} catch (InterruptedException e) {
			e.printStackTrace();
		...
		if (a == true) {
			test11.pass("Able to submit with select Tell us why and  without add Feedback");
		}
	}
	...
	public void b2_Feedback() {
		ExtentTest test12 = extentreport.createTest("Feedback - Validation",
				"Verify able to submit feedback with Alphanumerical only with max 250 characters, More than 250 characters, Less than 250 characters And Unable to submit With Special characters");
		...
		webDriver.findElement(By.xpath("//textarea[@name='feedback_text']"))
				.sendKeys("QWERTYUIOPASDFGHJKLZXCVBN#$@@!%QWERTYUIOPASDFGHJKLZXCVBN");
		try {
			TimeUnit.SECONDS.sleep(2);
		} catch (InterruptedException e) {
			e.printStackTrace();
		...
		boolean a = true;
		try {
			webDriver.findElement(By.xpath("//span[text()='Special Characters not allowed']"));
		} catch (NoSuchElementException e) {
			a = false;
		...
		if (a == true) {
			test12.pass(
					"Unable to submit With Special characters and Alert message shown while Special characters are added");
		}
		webDriver.findElement(By.xpath("//textarea[@name='feedback_text']")).clear();

		// With MORE THEN 250 CHARACTERS
		webDriver.findElement(By.xpath("//textarea[@name='feedback_text']")).sendKeys(
				"QWERTYUIOPASDFGHJKLZXCVBNQWERTYUIOPASDFGHJKLZXCVBNQWERTYUIOPASDFGHJKLZXCVBNQWERTYUIOPASDFGHJKLZXCVBNQWERTYUIOPASDFGHJKLZXCVBNQWERTYUIOPASDFGHJKLZXCVBNQWERTYUIOPASDFGHJKLZXCVBNQWERTYUIOPASDFGHJKLZXCVBNQWERTYUIOPASDFGHJKLZXCVBNQWERTYUIOPASDFGHJKLZXCVBNQWERT");
		try {
			TimeUnit.SECONDS.sleep(2);
		} catch (InterruptedException e) {
			e.printStackTrace();
		...
		a = true;
		try {
			webDriver.findElement(By.xpath("//span[text()='More than 250 characters not accepted']"));
		} catch (NoSuchElementException e) {
			a = false;
		...
		if (a == true) {
			test12.pass(
					"Unable to submit With More then 250 characters and Alert message shown while More then 250 characters are added");
		}
		webDriver.findElement(By.xpath("//textarea[@name='feedback_text']")).clear();

		// less then 250 characters
		webDriver.findElement(By.xpath("//textarea[@name='feedback_text']")).sendKeys(
				"QWERTYUIOPASDFGHJKLZXCVBNQWERTYUIOPASDFGHJKLZXCVBNQWERTYUIOPASDFGHJKLZXCVBNqwertyuiop123456");
		try {
			TimeUnit.SECONDS.sleep(2);
		} catch (InterruptedException e) {
			e.printStackTrace();
		...
		if (a == true) {
			test12.pass("Able to submit with less then 250 characters ");
		}
		...
		webDriver.findElement(By.xpath("//textarea[@name='feedback_text']")).sendKeys(
				"QWERTYUIOPASDFGHJKLZXCVBNQWERTYUIOPASDFGHJKLZXCVBNQWERTYUIOPASDFGHJKLZXCVBNQWERTYUIOPASDFGHJKLZXCVBNQWERTYUIOPASDFGHJKLZXCVBNQWERTYUIOPASDFGHJKLZXCVBNQWERTYUIOPASDFGHJKLZXCVBNQWERTYUIOPASDFGHJKLZXCVBNQWERTYUIOPASDFGHJKLZXCVBNQWERTYUIOPASDFGHJKLZXCVBN");
		try {
			TimeUnit.SECONDS.sleep(2);
		} catch (InterruptedException e) {
			e.printStackTrace();
		...
		if (a == true) {
			test12.pass("Able to submit with maximum 250 characters ");
		}
	}
	...
	public void b3_SubmittedPage() {
		ExtentTest test13 = extentreport.createTest("Submitted - Thanks page.",
				"Verify submitted page UI is shown fine.");
		...
		if (a == true) {
			test13.pass("Mobicip logo is present");
		}
		...
		if (a == true) {
			test13.pass("Back button is present");
		}
		...
		if (a == true) {
			test13.pass("About Mobicip - Header is correct");
		}
		try {
			TimeUnit.SECONDS.sleep(4);
		} catch (InterruptedException e) {
		...
		if (a == true) {
			test13.pass("Profile icon is present");
		}
		...
		if (a == true) {
			test13.pass("Help icon is present");
		}
		try {
			TimeUnit.SECONDS.sleep(3);
		} catch (InterruptedException e) {
		...
		if (a == true) {
			test13.pass("Notification icon is present");
		}
		...
		try {
			...
			a = false;
			test13.fail("Submit page UI is improper");
		}
		if (a == true) {
			test13.pass("Submit page UI is Proper");
		}
...
/*
 * webDriver.findElement(By.xpath("//div[@title='Vikram']")).click(); new
 ...
 * "/html/body/div[1]/div/header/div/div[2]/div/a[1]")));
 * webDriver.findElement(By.xpath(
 * "/html/body/div[1]/div/header/div/div[2]/div/a[1]")).click();
 * //webDriver.findElement(By.xpath("//span[text()='Logout']")).click(); //new
 * WebDriverWait(webDriver,Duration.ofSeconds(20)).until(ExpectedConditions.
