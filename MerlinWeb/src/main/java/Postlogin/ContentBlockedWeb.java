...
public class ContentBlockedWeb extends BrowserSetup{
	//Report setup
	...
	public void beforeTest() 
	{
		...
		spark = new ExtentSparkReporter("TestReports\\PostloginTest\\TestWebsites\\reportContentBlockedWeb.html");
	...
	public void a1_ContentBlockedWeb()
	{
		...
		//---Content - Blocked Web---
		a=true;
		try{webDriver.findElement(By.xpath("//span[text()='Blocked Websites']"));}
		catch(NoSuchElementException e) {a=false;
	...
	public void a3_ContentBlockedWeb()
	{
  		...
  		boolean a=true;
		try{webDriver.findElement(By.xpath("//p[text()='Mobicip by default blocks inappropriate websites which are unsafe for children.']"));
	...
	public void a4_ContentBlockedWeb()
	{
  		...
  		boolean a=true;
		try{webDriver.findElement(By.xpath("//input[@name='websiteName']"));}
		catch(NoSuchElementException e) {a=false;
		...
		a=true;
		try{webDriver.findElement(By.xpath("//p[text()='Use commas to add multiple websites. Example:']"));}
		catch(NoSuchElementException e) {a=false;
	...
	public void a5_ContentBlockedWeb()
	{
  		...
  		try{webDriver.findElement(By.xpath("//span[text()='No websites added']"));
  			webDriver.findElement(By.xpath("//div[@class='no_data_container websites']"));}
		catch(NoSuchElementException e) {a=false;
  	...
  	public void a6_ContentBlockedWeb()
	{
  		...
  		boolean a=true;
  		webDriver.findElement(By.xpath("//input[@name='websiteName']")).sendKeys("nytimes.com");
  		webDriver.findElement(By.xpath("//button[@class='link_button add']")).click();
		try {TimeUnit.SECONDS.sleep(3);} catch (InterruptedException e) {e.printStackTrace();}
  		try{webDriver.findElement(By.xpath("//span[text()='nytimes.com']"));}
  		catch(NoSuchElementException e) {a=false;
  		test.fail("Proper website is not added");}
  		if(a==true){test.pass("Proper website is added properly");}
  		
  		a=true;
  		webDriver.findElement(By.xpath("//input[@name='websiteName']")).sendKeys("123.com");
  		webDriver.findElement(By.xpath("//button[@class='link_button add']")).click();
  		try {TimeUnit.SECONDS.sleep(3);} catch (InterruptedException e) {e.printStackTrace();}
  		try{webDriver.findElement(By.xpath("//span[text()='123.com']"));}
  		catch(NoSuchElementException e) {a=false;
  		test.fail("Proper website is not added");}
  		if(a==true){test.pass("Proper website is added properly");}
  		
  		webDriver.findElement(By.xpath("//input[@name='websiteName']")).sendKeys("abcd");
  		webDriver.findElement(By.xpath("//button[@class='link_button add']")).click();
  		a=true;
  		try {TimeUnit.SECONDS.sleep(2);} catch (InterruptedException e) {e.printStackTrace();}
  		try{webDriver.findElement(By.xpath("//span[text()='Invalid url: Enter a valid url']"));}
  		catch(NoSuchElementException e) {a=false;
  		test.fail("Improper website is added");}
  		if(a==true){test.pass("Improper website is not added");}
  		webDriver.findElement(By.xpath("//input[@name='websiteName']")).clear();

  		 // We're sorry, but something went wrong (500) 
  		webDriver.findElement(By.xpath("//input[@name='websiteName']")).sendKeys("!@#abcd.com");
  		webDriver.findElement(By.xpath("//button[@class='link_button add']")).click();
  		a=true;
  		try {TimeUnit.SECONDS.sleep(2);} catch (InterruptedException e) {e.printStackTrace();}
  		try{webDriver.findElement(By.xpath("//span[text()='Invalid url: Enter a valid url']"));}
  		...
  		a=true;
  		try{webDriver.findElement(By.xpath("//span[text()=\"We're sorry, but something went wrong (500)\"]"));}
  		catch(NoSuchElementException e) {a=false;
  		...
  		webDriver.findElement(By.xpath("//input[@name='websiteName']")).sendKeys("hi#$jim.com");
  		webDriver.findElement(By.xpath("//button[@class='link_button add']")).click();
  		a=true;
  		try {TimeUnit.SECONDS.sleep(2);} catch (InterruptedException e) {e.printStackTrace();}
  		try{webDriver.findElement(By.xpath("//span[text()='Invalid url: Enter a valid url']"));}
  		...
  		webDriver.findElement(By.xpath("//input[@name='websiteName']")).sendKeys("123.com.com");
  		webDriver.findElement(By.xpath("//button[@class='link_button add']")).click();
  		a=true;
  		try{webDriver.findElement(By.xpath("//span[text()='Invalid url: Enter a valid url']"));}
  		catch(NoSuchElementException e) {a=false;
  		...
  		webDriver.findElement(By.xpath("//input[@name='websiteName']")).sendKeys("abcd.com,abcd.com,abcd.com");
  		webDriver.findElement(By.xpath("//button[@class='link_button add']")).click();
  		a=true;
  		try {TimeUnit.SECONDS.sleep(2);} catch (InterruptedException e) {e.printStackTrace();}
  		try{webDriver.findElement(By.xpath("//span[text()='Duplicate Urls Exist']"));}
  		catch(NoSuchElementException e) {a=false;
  		test.fail("Duplicates website are added");}
  		if(a==true){test.pass("Duplicates website are not added");}
  		webDriver.findElement(By.xpath("//input[@name='websiteName']")).clear();
  		
  		webDriver.findElement(By.xpath("//input[@name='websiteName']")).sendKeys("abcd.com,,abcd.com");
  		webDriver.findElement(By.xpath("//button[@class='link_button add']")).click();
  		a=true;
  		try {TimeUnit.SECONDS.sleep(2);} catch (InterruptedException e) {e.printStackTrace();}
  		try{webDriver.findElement(By.xpath("//span[text()='Invalid url: Enter a valid url']"));}
  		...
  		webDriver.findElement(By.xpath("//input[@name='websiteName']")).sendKeys("!@#.com, abcd.com");
  		webDriver.findElement(By.xpath("//button[@class='link_button add']")).click();
  		a=true;
  		try {TimeUnit.SECONDS.sleep(2);} catch (InterruptedException e) {e.printStackTrace();}
  		try{webDriver.findElement(By.xpath("//span[text()='Invalid url: Enter a valid url']"));}
 	...
 	public void a8_ContentBlockedWeb()
	{
  		...
  		boolean a=true;
  		webDriver.findElement(By.xpath("//input[@name='websiteName']")).sendKeys("allowed.com");
  		webDriver.findElement(By.xpath("//button[@class='link_button add']")).click();
  		a=true;
  		try {TimeUnit.SECONDS.sleep(2);} catch (InterruptedException e) {e.printStackTrace();}
  		try{webDriver.findElement(By.xpath("//p[text()='. Do you want to ']"));
  		...
  		try{webDriver.findElement(By.xpath("//span[text()='allowed.com']"));}
  		catch(NoSuchElementException e) {a=false;
 	...
 	public void a9_ContentBlockedWeb()
	{
		...
		try {TimeUnit.SECONDS.sleep(2);} catch (InterruptedException e) {e.printStackTrace();}
  		//delete one website
  		try {TimeUnit.SECONDS.sleep(1);} catch (InterruptedException e) {e.printStackTrace();}
  		webDriver.findElement(By.xpath("//span[text()='nytimes.com']/preceding::label[1]")).click();
  		try {TimeUnit.SECONDS.sleep(1);} catch (InterruptedException e) {e.printStackTrace();}
  		try{webDriver.findElement(By.xpath("//span[text()='1']"));
  			webDriver.findElement(By.xpath("//span[text()='website']"));
  		...
  		try {TimeUnit.SECONDS.sleep(2);} catch (InterruptedException e) {e.printStackTrace();}
  		try{webDriver.findElement(By.xpath("//div[text()='Delete '  and text()='1' and text()='blocked' and text()='website' and text()='?']"));
			webDriver.findElement(By.xpath("//div[text()='No']"));
			webDriver.findElement(By.xpath("//button[text()='Yes']"));} 
		catch(NoSuchElementException e) {a=false;
		...
		//Delete more than one website
  		try {TimeUnit.SECONDS.sleep(1);} catch (InterruptedException e) {e.printStackTrace();}
  		webDriver.findElement(By.xpath("//span[text()='123.com.com']/preceding::label[1]")).click();
  		webDriver.findElement(By.xpath("//span[text()='123.com']/preceding::label[1]")).click();
  		try {TimeUnit.SECONDS.sleep(1);} catch (InterruptedException e) {e.printStackTrace();}
  		try{webDriver.findElement(By.xpath("//span[text()='2']"));
  			webDriver.findElement(By.xpath("//span[text()='websites']"));
  			webDriver.findElement(By.xpath("//span[text()=' selected']"));
  			webDriver.findElement(By.xpath("//span[text()='Delete selected']"));} 
  		catch(NoSuchElementException e) {a=false;
  		...
  		webDriver.findElement(By.xpath("//span[text()='Delete selected']")).click();
  		try {TimeUnit.SECONDS.sleep(2);} catch (InterruptedException e) {e.printStackTrace();}
  		try{webDriver.findElement(By.xpath("//div[text()='Delete '  and text()='2' and text()='blocked' and text()='websites' and text()='?']"));
			webDriver.findElement(By.xpath("//div[text()='No']"));
			webDriver.findElement(By.xpath("//button[text()='Yes']"));} 
		catch(NoSuchElementException e) {a=false;
		...
		try {TimeUnit.SECONDS.sleep(2);} catch (InterruptedException e) {e.printStackTrace();}
		a=true;
		try{webDriver.findElement(By.xpath("//span[text()='123.com.com']"));
			webDriver.findElement(By.xpath("//span[text()='123.com']"));} 
		catch(NoSuchElementException e) {a=false;
		...
		//Delete All websites
		a=true;
  		webDriver.findElement(By.xpath("//span[text()='allowed.com']/preceding::label[1]")).click();
  		try {TimeUnit.SECONDS.sleep(1);} catch (InterruptedException e) {e.printStackTrace();}
	...
	public void b1_ContentAllowedWeb()
	{
		...
		//--- Content - Allowed Web ---
		boolean a=true;
		try{webDriver.findElement(By.xpath("//span[text()='Allowed Websites']"));}
		catch(NoSuchElementException e) {a=false;
	...
	public void b3_ContentAllowedWeb()
	{
  		...
  		boolean a=true;
		try{webDriver.findElement(By.xpath("//p[text()='The websites listed below will not be blocked by Mobicip.']"));
			webDriver.findElement(By.xpath("//p[text()='Settings will not apply to Mobicip preset schedules.']"));}
		catch(NoSuchElementException e) {a=false;
 	...
 	public void b9_ContentAllowedWeb()
	{
  		...
  		boolean a=true;
  		try{webDriver.findElement(By.xpath("//span[text()='Whitelist only mode']"));
			webDriver.findElement(By.xpath("//p[text()='Enabling will allow ONLY the websites added here']"));
			webDriver.findElement(By.xpath("//label[@class='toggle_switch']"));}
		catch(NoSuchElementException e) {a=false;
 	...
 	public void c0_ContentAllowedWeb()
	{
  		...
  		boolean a=true;
  		webDriver.findElement(By.xpath("//label[@class='toggle_switch']")).click();
  		try {TimeUnit.SECONDS.sleep(2);} catch (InterruptedException e) {e.printStackTrace();}
  		try{webDriver.findElement(By.xpath("//p[text()='Enabling whitelist only mode will allow ONLY the sites added here. All other sites will be blocked.']"));
			webDriver.findElement(By.xpath("//div[text()='Cancel']"));
			webDriver.findElement(By.xpath("//button[text()='Continue']"));}
		catch(NoSuchElementException e) {a=false;
 	...
 	public void c1_ContentAllowedWeb()
	{
		...
		try {TimeUnit.SECONDS.sleep(2);} catch (InterruptedException e) {e.printStackTrace();}
  		...
  		webDriver.findElement(By.xpath("//span[text()='Delete selected']")).click();
  		try {TimeUnit.SECONDS.sleep(2);} catch (InterruptedException e) {e.printStackTrace();}
  		try{webDriver.findElement(By.xpath("//div[text()='Delete '  and text()='1' and text()='allowed' and text()='website' and text()='?']"));
			webDriver.findElement(By.xpath("//div[text()='No']"));
			webDriver.findElement(By.xpath("//button[text()='Yes']"));} 
		catch(NoSuchElementException e) {a=false;
		test.fail("One website Delete - Popup - not displayed properly");}
		...
		//Delete more than one website
  		...
  		webDriver.findElement(By.xpath("//span[text()='Delete selected']")).click();
  		try {TimeUnit.SECONDS.sleep(2);} catch (InterruptedException e) {e.printStackTrace();}
  		try{webDriver.findElement(By.xpath("//div[text()='Delete '  and text()='2' and text()='allowed' and text()='websites' and text()='?']"));
			webDriver.findElement(By.xpath("//div[text()='No']"));
			webDriver.findElement(By.xpath("//button[text()='Yes']"));} 
		catch(NoSuchElementException e) {a=false;
		test.fail("More than One Websites Delete - Popup - not displayed properly");}
