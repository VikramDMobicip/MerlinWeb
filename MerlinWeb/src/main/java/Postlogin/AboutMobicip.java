...
public class AboutMobicip extends BrowserSetup{
    ...
    public void beforeTest()
    {
		...
		spark = new ExtentSparkReporter("TestReports\\PostloginTest\\AboutMobicip\\reportAboutMobicip.html");
	...
	public void a1_homepage()
	{
		...
		ClickwithDelay(webDriver,"//span[text()='About Mobicip']");
		new WebDriverWait(webDriver,Duration.ofSeconds(20)).until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//p[text()='About Mobicip']")));
	...
	public void a3_TermsandConditions() {
  		...
  		boolean a = true;
  		try{webDriver.findElement(By.xpath("//p[text()='Terms and Conditions']")); 
  		webDriver.findElement(By.xpath("//p[text()='Terms and Conditions']/following-sibling::span[@class='icon_right_arrow']"));}
		catch(NoSuchElementException e){a=false;
		...
		new WebDriverWait(webDriver,Duration.ofSeconds(20)).until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//p[text()='Terms & Conditions']")));
		String tit = webDriver.getTitle();
		...
		a=true;
		try{webDriver.findElement(By.xpath("//p[text()='Terms & Conditions']"));} 
		catch(NoSuchElementException e){a=false;
		...
		a=true;
		try{webDriver.findElement(By.xpath("//span[text()='Mobicip Services']"));} 
		catch(NoSuchElementException e){a=false;
		test3.fail("Mobicip Services section  is not present");}
		if(a==true) {test3.pass("Mobicip section icon is present");}

		a=true;
		try{webDriver.findElement(By.xpath("//span[text()='Disclaimer for Mobicip Service']"));} 
		catch(NoSuchElementException e){a=false;
		...
		new WebDriverWait(webDriver,Duration.ofSeconds(20)).until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//span[text()='Payment']")));
	    a=true;
		try{webDriver.findElement(By.xpath("//span[text()='Payment']"));} 
		catch(NoSuchElementException e){a=false;
		...
		a=true;
		new WebDriverWait(webDriver,Duration.ofSeconds(20)).until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//span[text()='Patents']")));
		try{webDriver.findElement(By.xpath("//span[text()='Patents']"));} 
		catch(NoSuchElementException e){a=false;
	...
	public void a4_TermsandConditions() {
  		...
  		boolean a = true;
		new WebDriverWait(webDriver,Duration.ofSeconds(20)).until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//p[text()='Privacy Policy']")));
  		try{webDriver.findElement(By.xpath("//p[text()='Privacy Policy']")); 
  		webDriver.findElement(By.xpath("//p[text()='Privacy Policy']/following-sibling::span[@class='icon_right_arrow']"));}
		catch(NoSuchElementException e){a=false;
		...
		a=true;
		try{webDriver.findElement(By.xpath("//span[text()='Parent Privacy']"));} 
		catch(NoSuchElementException e){a=false;
		...
		if(a==true) {test3.pass("Parent Privacy icon is present");}
  		...
  		JavascriptExecutor j = (JavascriptExecutor)webDriver;
		j.executeScript("window.scrollBy(0,600)"); 
		new WebDriverWait(webDriver,Duration.ofSeconds(20)).until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//span[text()='Third-Party Information Sharing']")));

		a=true;
		try{webDriver.findElement(By.xpath("//span[text()='Third-Party Information Sharing']"));} 
		catch(NoSuchElementException e){a=false;
		...
		new WebDriverWait(webDriver,Duration.ofSeconds(20)).until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//span[text()='Child Privacy']")));
	    a=true;
		try{webDriver.findElement(By.xpath("//span[text()='Child Privacy']"));} 
		catch(NoSuchElementException e){a=false;
		test3.fail("Child Privacy section  is not present");}
		if(a==true) {test3.pass("Child Privacy  icon is present");}
		
		j.executeScript("window.scrollBy(0,3000)"); 
		new WebDriverWait(webDriver,Duration.ofSeconds(20)).until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//span[text()='Data Collection and Reporting']")));
		a=true;
		try{webDriver.findElement(By.xpath("//span[text()='Data Collection and Reporting']"));} 
		catch(NoSuchElementException e){a=false;
		...
		try {TimeUnit.SECONDS.sleep(3);} catch (InterruptedException e) {e.printStackTrace();}
		new WebDriverWait(webDriver,Duration.ofSeconds(20)).until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//p[text()='Hello Vikram!']")));
  	}
